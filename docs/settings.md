...
| `exa.includeSummary`                | boolean | `true`    | Request per-result summaries from Exa. Summaries are billed per result on top of the search; `false` omits them to cut Exa cost.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `exa.searchType`                    | enum    | `default` | `default`, `auto`, `fast`, `neural`, `deep`. Exa retrieval strategy; `fast` is cheapest per request, `default` defers to the caller's requested type.                                                                                                                                                                                                                                                                                                                                                                                                                   |
