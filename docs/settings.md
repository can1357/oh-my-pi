...
| `history.scope`        | enum    | `global`        | `session`, `cwd`, `repo`, `global`. What the `Up` arrow recalls: all projects (default, as before), this session, the current folder, or this repository (worktrees included). |
