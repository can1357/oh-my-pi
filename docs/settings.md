...
| `memory.backend`              | enum    | `off`                                    | `off`, `local`, `hindsight`, `mnemopi`, `sharpshooter`, `dakera`. Each backend has its own `hindsight.*` / `mnemopi.*` / `dakera.*` / `sharpshooter.*` / `memories.*` tuning keys.                                                          |
