...
| `providers.fetch`                   | enum    | `auto`    | `auto`, `native`, `trafilatura`, `lynx`, `parallel`, `querit`, `jina`. Pin `querit` with `omp config set providers.fetch querit` to prefer the Querit contents reader for `read` URLs.                                                                                                                                                                                                                                           |
