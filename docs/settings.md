...
| `reasoningLanguage`               | enum    | `auto`  | Language of visible thinking text on providers that stream raw reasoning. `auto` follows a clearly Chinese user turn, `off` injects nothing, `zh`/`en` always ask for that language. The request-time `<reasoning-language>` block rides the user turn, so earlier turns stay byte-identical and prompt caching is preserved.                                                                                                                                                                                                                                                                                   |
