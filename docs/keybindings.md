...
| `app.session.pin`            | `Alt+K`                                                               | Pin the selected session in the Resume Session picker                                                                                                                                |
| `app.session.unpin`          | `Alt+Shift+K`                                                         | Unpin the selected session in the Resume Session picker                                                                                                                              |
