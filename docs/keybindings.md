...
| `app.clipboard.copyCodeBlock` | `Alt+Y`                                                               | Copy the nearest code block (press again to walk to older blocks)                                                                                                                    |
| `app.clipboard.copyCodeBlockPrev` | `Alt+Shift+Y`                                                     | Copy the next code block toward newer (walk the block cycle backward)                                                                                                                |
