...
| `app.clipboard.copyCodeBlock`| `Alt+Shift+Y`                                                         | Copy the newest assistant code block; press again to walk to older blocks (wraps after the oldest)                                                                                   |
| `app.clipboard.copyCodeBlockPrev` | `Ctrl+Alt+Y`                                                     | Copy the next newer code block in the walk                                                                                                                                           |
