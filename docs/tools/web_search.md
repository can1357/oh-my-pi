...
| `recency` | `"day" \| "week" \| "month" \| "year"` | No | Relative time filter. Implemented by Serper, Brave, Perplexity, Tavily, SearXNG, Kagi, TinyFish, Firecrawl, DuckDuckGo, Startpage, Google, and Mojeek; other adapters ignore it. |
