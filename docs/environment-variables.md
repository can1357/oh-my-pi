...
| `EXLLAMAV3_API_KEY`             | ExLlamaV3/TabbyAPI auth                          | Using `exllamav3` provider (local TabbyAPI server)             | TabbyAPI key from `api_tokens.yml`; `EXLLAMAV3_BASE_URL` overrides the default `http://127.0.0.1:5000/v1` |
