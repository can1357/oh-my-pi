...
| `MNEMOPI_POLYPHONIC_RECALL`  | Overrides `mnemopi.polyphonicRecall` when set (`0`/`false` off, otherwise on)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `MNEMOPI_ENHANCED_RECALL`    | Overrides `mnemopi.enhancedRecall` when set; also gates the recall query cache                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `MNEMOPI_PROACTIVE_LINKING`  | Overrides `mnemopi.proactiveLinking` when set                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `MNEMOPI_VOICE_VECTOR`, `MNEMOPI_VOICE_GRAPH`, `MNEMOPI_VOICE_FACT`, `MNEMOPI_VOICE_TEMPORAL` | `0` disables that polyphonic recall voice; used to isolate or A/B one voice's contribution                                                                                                                                                                                                                                                                                                                                                             |
| `MNEMOPI_CROSS_PROJECT_RECALL` | `1` extends recall (never writes) to non-empty sibling project banks, so a second checkout or worktree of the same repository can reach memories retained under another absolute path. Requires a scoping mode that resolves more than one recall bank, i.e. `per-project-tagged` only; off by default                                                                                                                                                                                                                                                                                                     |
