...
| `OPENLLM_API_KEY`               | OpenLLM auth                                     | Using `openllm` provider                                       | OpenLLM gateway key (`sk-llm-...`)                                                                  |
...
| `OPENLLM_BASE_URL`           | OpenLLM gateway base URL fallback (`https://openllm.sh/v1` if unset, e.g. a local daemon at `http://127.0.0.1:8787/v1`); explicit `providers.openllm.baseUrl` / `models.yml` config wins                                                                                                                                                                                                                                                                                                                                                                                                                    |
