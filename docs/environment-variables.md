...
| `VOLCENGINE_AGENT_PLAN_API_KEY` | Volcengine Ark Agent Plan auth                   | Using `volcengine-agent-plan` provider                         | Preferred provider-specific name; must be a dedicated Agent Plan key                                |
