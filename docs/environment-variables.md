...
| `OPENZOO_API_KEY`               | openzoo auth (optional)                          | Using `openzoo` behind a public tunnel URL                     | The local proxy is keyless and counts as authenticated without this; any value works locally        |
...
| `OPENZOO_BASE_URL`           | openzoo proxy base URL fallback (`http://localhost:8402/v1` if unset); explicit `providers.openzoo.baseUrl` / `models.yml` config wins                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
