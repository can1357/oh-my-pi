...
| `OPENLLM_API_KEY`               | OpenLLM auth/discovery opt-in                    | Using `openllm` provider (local gateway daemon)                | Any non-empty value works; the daemon carries its own upstream credentials                          |
...
| `OPENLLM_BASE_URL`           | OpenLLM daemon base URL override (`http://127.0.0.1:8787/v1` if unset)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
