...
| `OMP_MCP_MAX_TIMEOUT_MS`     | Ceiling (ms) on how long `notifications/progress` may keep extending one MCP request. `0` removes the ceiling. Invalid values are ignored with a warning and the default (`3600000`) is used.                                                                                                                                                                                                                                                                                                                                                                                              |
