...
Always-apply rules are deduplicated against the effective custom/append prompt sources and loaded context-file bodies. Remaining raw bodies render inside `<generic-rules>` before the rulebook listing.
