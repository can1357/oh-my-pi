...
- **Assistant message tier fact**: The assistant message field is the requested per-call value, not a server grant; response echoes and usage are the authority when a provider downgrades or serves a different tier.
