...
- `compaction.remoteTimeoutMs` is unset by default, preserving the V2 request deadline of `180000` milliseconds per attempt. Set `600000` for ten minutes; non-positive values disable this V2 deadline. This does not change retry behavior, fallback selection, or legacy V1 timeouts.
