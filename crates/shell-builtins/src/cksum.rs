...
impl LineFormat {
	...
	#[allow(
		...
		reason = "the linked output format uses literal angle brackets"
	)]
...
mod tests {
	...
	fn test_algo_based_parser() {
		#[allow(clippy::type_complexity, reason = "the cases mirror the parser's four output fields")]
	...
	fn test_double_space_parser() {
		#[allow(clippy::type_complexity, reason = "the cases mirror the parser's two output fields")]
