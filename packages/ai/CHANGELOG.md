...
- Fixed ToolCallLoopGuard zeroing its consecutive-repeat counter when all tool calls in a turn are exempt, allowing interleaved polling turns to bypass repeat detection.
