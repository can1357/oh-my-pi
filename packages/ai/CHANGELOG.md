...
- Credential-dependent request metadata now refreshes after every API-key selection and auth retry, keeping account attribution aligned when the resolver rotates credentials.
