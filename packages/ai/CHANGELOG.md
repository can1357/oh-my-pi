...
- Added DigitalOcean Serverless Inference provider login support via `DIGITALOCEAN_API_KEY` fallback ([#10303](https://github.com/can1357/oh-my-pi/pull/10303) by [@khayyamsaleem](https://github.com/khayyamsaleem)).
