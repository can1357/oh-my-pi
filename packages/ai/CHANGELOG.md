...
- Fixed Google Antigravity requests returning false 429 quota exhaustion errors by omitting the `requestType: "agent"` field from the request envelope, matching official Antigravity client behavior.
