...
- Fixed custom OpenAI Responses streams crashing on omitted delta payloads or reasoning-summary fields, and recovered text delivered only in completed snapshots.
