...
export class AuthStorage {
	...
	getCredentialOrigin(provider: string): CredentialOrigin | undefined {
		...
		const preferredType = this.#preferredInteractiveCredentialType(provider);
		if (
	...
	#resolveActiveOAuthCredential(provider: string, sessionId?: string): OAuthCredential | undefined {
		...
		if (!sessionPref && this.#preferredInteractiveCredentialType(provider) === "api_key") return undefined;
