/**
 * Hand-rolled protobuf for Cursor sand InferenceService Stream.
 ...
 *
 * Ported from the working Grok Bot extension; typed surface is the exported
 * encode/decode/frame helpers. Internal field walkers stay loosely typed.
 */
// @ts-nocheck
