/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0166fad970dd3b7ddaf5fd1153740db9)
...
interface __BaseEnv_Env {
	...
	HUB_BLOBS: R2Bucket;
	ASSETS: Fetcher;
	COLLAB_ROOMS: DurableObjectNamespace<import("./src/index").CollabRoom>;
	SHARE_UPLOADS: DurableObjectNamespace<import("./src/index").ShareUploadRateLimit>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CollabRoom" | "ShareUploadRateLimit";
	}
