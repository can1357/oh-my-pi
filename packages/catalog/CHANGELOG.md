...
- Model discovery now logs a warning naming the models an authoritative catalog dropped since the last refresh, instead of letting them vanish from the picker silently ([#11913](https://github.com/can1357/oh-my-pi/pull/11913) by [@alphastorm](https://github.com/alphastorm)).
- Model discovery now logs a warning naming the models an authoritative catalog dropped since the last refresh, instead of letting them vanish from the picker silently. Credential-shaped provider/model labels are redacted after comparing the original model identities ([#11913](https://github.com/can1357/oh-my-pi/pull/11913) by [@alphastorm](https://github.com/alphastorm)).
