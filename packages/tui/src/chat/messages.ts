...
export interface CustomMessage<T = unknown> {
	...
	/** Persisted rollback ownership, stamped by AgentSession when the message
	 * enters the prompt flow (`/undo`, `/revert`). Siblings of `details` so
	 * extension payloads of any shape — including primitives and arrays —
	 * stay untouched; forwarded verbatim to the journal entry and replay. */
	userTurn?: boolean;
