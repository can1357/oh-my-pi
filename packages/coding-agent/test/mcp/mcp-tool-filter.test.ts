 ...
 *   filter that excludes every advertised tool reports `filterEmpty` so
 *   callers clear stale tools and surface a failure instead of silently
...
import { filterMCPTools, mcpToolFilterKey } from "@oh-my-pi/pi-coding-agent/mcp/tool-filter";
