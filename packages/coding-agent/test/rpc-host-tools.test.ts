...
import { defineRpcClientTool, RpcClient } from "@pk-nerdsaver-ai/pi-coding-agent/modes";
import { RpcHostToolBridge } from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/host-tools";
import type {
