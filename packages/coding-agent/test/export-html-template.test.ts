...
// Computed from assets generated by the repo's pinned toolchain
// (`packageManager: bun@1.4.0` — CI regenerates the gitignored
// `tool-views.generated.js` via the root `prepare` script on install, so these
// constants MUST match that Bun version's bundler output, not whatever local
// Bun produced it last; regenerate with `bunx bun@1.4.0 scripts/build-tool-views.ts`
// in packages/collab-web before recomputing).
const expectedTemplate: TemplateProbeResult = {
	chars: 377_420,
	bytes: 377_576,
	sha256: "ee702f6dcc1b00d9b7ce7937f5db639f92700a7a39d3dc5c2f5328c8c435a04d",
	stableCache: true,
	assetsRemoved: 0,
};
