 ...
 * per-candidate availability check in {@link ContextMaintenance.runAutoCompaction}'s
...
/** Capabilities required by the shared context-maintenance controller. */
export interface ContextMaintenanceHost {
	agent: Agent;
