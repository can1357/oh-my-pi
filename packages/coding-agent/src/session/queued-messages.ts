...
/** Hidden companion carrying a video contact-sheet's source path. */
export const VIDEO_ATTACHMENT_NOTICE_TYPE = "video-attachment";
...
export function isHiddenUserCompanion(message: AgentMessage): boolean {
	return (
		...
		(MAGIC_KEYWORD_NOTICE_TYPES[message.customType] === true ||
			...
			message.customType === VIDEO_ATTACHMENT_NOTICE_TYPE)
	);
}
