...
export class AgentSession {
	 ...
	 * - Not streaming + no trigger: appends to state/session, no turn; a display:true message
	 *   paints to the interactive transcript immediately (message_start/message_end, no turn)
	 *
