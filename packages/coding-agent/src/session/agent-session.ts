...
export class AgentSession {
	...
	#sessionGeneration = 0;
	/** Shared by readiness observers and aside-generation checks. Settles only after the
	 *  outermost session/transcript transition finishes, including hooks and rollback. */
