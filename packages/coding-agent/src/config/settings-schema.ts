...
export const SETTINGS_SCHEMA = {
	...
	"jevRouting.minConfidenceToDegrade": {
		type: "number",
		default: 0.85,
		ui: {
			tab: "model",
	...
	"jevRouting.maxComplexityForDegrade": {
		type: "number",
		default: 0.5,
		ui: {
			tab: "model",
	...
	"jevRouting.minComplexityConfidence": {
		type: "number",
		default: 0.5,
		ui: {
			tab: "model",
	...
	"jevRouting.minConfidenceToEscalate": {
		type: "number",
		default: 0.7,
		ui: {
			tab: "model",
	...
	"jevRouting.maxEscalationsPerTurn": {
		type: "number",
		default: 1,
		ui: {
			tab: "model",
...
/** One routing tier in `jevRouting.tiers` — ordered cheapest → most capable. */
export interface JevRoutingTier {
