...
export const SETTINGS_SCHEMA = {
	...
	"providers.fetch": {
		type: "enum",
		values: ["auto", "native", "trafilatura", "lynx", "parallel", "querit", "jina"] as const,
		default: "auto",
		ui: {
			tab: "providers",
			group: "Services",
			...
			options: [
				{
					value: "auto",
					label: "Auto",
					description: "Priority: native > trafilatura > lynx > parallel > querit > jina",
				},
				...
				{ value: "querit", label: "Querit", description: "Requires /login querit or QUERIT_API_KEY" },
