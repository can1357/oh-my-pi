...
const SETTING_HOOKS: Partial<Record<SettingPath, SettingHook<any>>> = {
	...
	"hindsight.bankIdTemplate": () => hindsightScopeSignal.fire(),
...
/** Fires when any Hindsight bank-routing setting changes. */
 ...
 * `hindsight.bankIdTemplate`, or `hindsight.scoping` mid-session so subsequent
 * retain/recall calls land in the new bank instead of the one selected at
 * session start.
 *
