...
export class ExtensionRunner {
	...
	/**
	 * Whether {@link initialize} has run. Until it does, `emitCredentialDisabled`
	 * only buffers: no extension handler has seen the event, so a caller tearing
	 * startup down must still treat it as undelivered.
	 */
	get credentialDisabledHandlersReady(): boolean {
