 ...
 */
import * as bundledPiAgentCore from "@pk-nerdsaver-ai/pi-agent-core";
import * as bundledPiAgentCoreCompaction from "@pk-nerdsaver-ai/pi-agent-core/compaction";
import * as bundledPiAgentCoreCompactionBranchSummarization from "@pk-nerdsaver-ai/pi-agent-core/compaction/branch-summarization";
import * as bundledPiAgentCoreCompactionCompaction from "@pk-nerdsaver-ai/pi-agent-core/compaction/compaction";
import * as bundledPiAgentCoreCompactionEntries from "@pk-nerdsaver-ai/pi-agent-core/compaction/entries";
import * as bundledPiAgentCoreCompactionErrors from "@pk-nerdsaver-ai/pi-agent-core/compaction/errors";
import * as bundledPiAgentCoreCompactionMessages from "@pk-nerdsaver-ai/pi-agent-core/compaction/messages";
import * as bundledPiAgentCoreCompactionOpenai from "@pk-nerdsaver-ai/pi-agent-core/compaction/openai";
import * as bundledPiAgentCoreCompactionPruning from "@pk-nerdsaver-ai/pi-agent-core/compaction/pruning";
import * as bundledPiAgentCoreCompactionShake from "@pk-nerdsaver-ai/pi-agent-core/compaction/shake";
import * as bundledPiAgentCoreCompactionToolProtection from "@pk-nerdsaver-ai/pi-agent-core/compaction/tool-protection";
import * as bundledPiAgentCoreCompactionUtils from "@pk-nerdsaver-ai/pi-agent-core/compaction/utils";
import * as bundledPiAiAuthBroker from "@pk-nerdsaver-ai/pi-ai/auth-broker";
import * as bundledPiAiAuthBrokerClient from "@pk-nerdsaver-ai/pi-ai/auth-broker/client";
import * as bundledPiAiAuthBrokerDiscover from "@pk-nerdsaver-ai/pi-ai/auth-broker/discover";
import * as bundledPiAiAuthBrokerRefresher from "@pk-nerdsaver-ai/pi-ai/auth-broker/refresher";
import * as bundledPiAiAuthBrokerRemoteStore from "@pk-nerdsaver-ai/pi-ai/auth-broker/remote-store";
import * as bundledPiAiAuthBrokerServer from "@pk-nerdsaver-ai/pi-ai/auth-broker/server";
import * as bundledPiAiAuthBrokerSnapshotCache from "@pk-nerdsaver-ai/pi-ai/auth-broker/snapshot-cache";
import * as bundledPiAiAuthBrokerTypes from "@pk-nerdsaver-ai/pi-ai/auth-broker/types";
import * as bundledPiAiAuthBrokerWireSchemas from "@pk-nerdsaver-ai/pi-ai/auth-broker/wire-schemas";
import * as bundledPiAiAuthGateway from "@pk-nerdsaver-ai/pi-ai/auth-gateway";
import * as bundledPiAiAuthGatewayHttp from "@pk-nerdsaver-ai/pi-ai/auth-gateway/http";
import * as bundledPiAiAuthGatewayServer from "@pk-nerdsaver-ai/pi-ai/auth-gateway/server";
import * as bundledPiAiAuthGatewayTypes from "@pk-nerdsaver-ai/pi-ai/auth-gateway/types";
import * as bundledPiAiDialect from "@pk-nerdsaver-ai/pi-ai/dialect";
import * as bundledPiAiError from "@pk-nerdsaver-ai/pi-ai/error";
import * as bundledPiAiOauth from "@pk-nerdsaver-ai/pi-ai/oauth";
import * as bundledPiAiOauthAnthropic from "@pk-nerdsaver-ai/pi-ai/oauth/anthropic";
import * as bundledPiAiOauthCallbackServer from "@pk-nerdsaver-ai/pi-ai/oauth/callback-server";
import * as bundledPiAiOauthCursor from "@pk-nerdsaver-ai/pi-ai/oauth/cursor";
import * as bundledPiAiOauthDevin from "@pk-nerdsaver-ai/pi-ai/oauth/devin";
import * as bundledPiAiOauthGithubCopilot from "@pk-nerdsaver-ai/pi-ai/oauth/github-copilot";
import * as bundledPiAiOauthGitlabDuo from "@pk-nerdsaver-ai/pi-ai/oauth/gitlab-duo";
import * as bundledPiAiOauthGitlabDuoWorkflow from "@pk-nerdsaver-ai/pi-ai/oauth/gitlab-duo-workflow";
import * as bundledPiAiOauthGoogleAntigravity from "@pk-nerdsaver-ai/pi-ai/oauth/google-antigravity";
import * as bundledPiAiOauthGoogleGeminiCli from "@pk-nerdsaver-ai/pi-ai/oauth/google-gemini-cli";
import * as bundledPiAiOauthGoogleOauthShared from "@pk-nerdsaver-ai/pi-ai/oauth/google-oauth-shared";
import * as bundledPiAiOauthKimi from "@pk-nerdsaver-ai/pi-ai/oauth/kimi";
import * as bundledPiAiOauthMinimaxCode from "@pk-nerdsaver-ai/pi-ai/oauth/minimax-code";
import * as bundledPiAiOauthOpenaiCodex from "@pk-nerdsaver-ai/pi-ai/oauth/openai-codex";
import * as bundledPiAiOauthOpencode from "@pk-nerdsaver-ai/pi-ai/oauth/opencode";
import * as bundledPiAiOauthPerplexity from "@pk-nerdsaver-ai/pi-ai/oauth/perplexity";
import * as bundledPiAiOauthPkce from "@pk-nerdsaver-ai/pi-ai/oauth/pkce";
import * as bundledPiAiOauthTypes from "@pk-nerdsaver-ai/pi-ai/oauth/types";
import * as bundledPiAiOauthWafer from "@pk-nerdsaver-ai/pi-ai/oauth/wafer";
import * as bundledPiAiOauthXaiOauth from "@pk-nerdsaver-ai/pi-ai/oauth/xai-oauth";
import * as bundledPiAiOauthXiaomi from "@pk-nerdsaver-ai/pi-ai/oauth/xiaomi";
import * as bundledPiAiProvidersAmazonBedrock from "@pk-nerdsaver-ai/pi-ai/providers/amazon-bedrock";
import * as bundledPiAiProvidersAnthropic from "@pk-nerdsaver-ai/pi-ai/providers/anthropic";
import * as bundledPiAiProvidersAnthropicClient from "@pk-nerdsaver-ai/pi-ai/providers/anthropic-client";
import * as bundledPiAiProvidersAnthropicMessagesServer from "@pk-nerdsaver-ai/pi-ai/providers/anthropic-messages-server";
import * as bundledPiAiProvidersAnthropicMessagesServerSchema from "@pk-nerdsaver-ai/pi-ai/providers/anthropic-messages-server-schema";
import * as bundledPiAiProvidersAnthropicWire from "@pk-nerdsaver-ai/pi-ai/providers/anthropic-wire";
import * as bundledPiAiProvidersAwsCredentials from "@pk-nerdsaver-ai/pi-ai/providers/aws-credentials";
import * as bundledPiAiProvidersAwsEventstream from "@pk-nerdsaver-ai/pi-ai/providers/aws-eventstream";
import * as bundledPiAiProvidersAwsSigv4 from "@pk-nerdsaver-ai/pi-ai/providers/aws-sigv4";
import * as bundledPiAiProvidersAzureOpenaiResponses from "@pk-nerdsaver-ai/pi-ai/providers/azure-openai-responses";
import * as bundledPiAiProvidersCursor from "@pk-nerdsaver-ai/pi-ai/providers/cursor";
import * as bundledPiAiProvidersDevin from "@pk-nerdsaver-ai/pi-ai/providers/devin";
import * as bundledPiAiProvidersErrorMessage from "@pk-nerdsaver-ai/pi-ai/providers/error-message";
import * as bundledPiAiProvidersGithubCopilotHeaders from "@pk-nerdsaver-ai/pi-ai/providers/github-copilot-headers";
import * as bundledPiAiProvidersGitlabDuo from "@pk-nerdsaver-ai/pi-ai/providers/gitlab-duo";
import * as bundledPiAiProvidersGitlabDuoWorkflow from "@pk-nerdsaver-ai/pi-ai/providers/gitlab-duo-workflow";
...
import * as bundledPiAiProvidersGrammar from "@pk-nerdsaver-ai/pi-ai/providers/grammar";
import * as bundledPiAiProvidersKimi from "@pk-nerdsaver-ai/pi-ai/providers/kimi";
import * as bundledPiAiProvidersMock from "@pk-nerdsaver-ai/pi-ai/providers/mock";
import * as bundledPiAiProvidersOllama from "@pk-nerdsaver-ai/pi-ai/providers/ollama";
import * as bundledPiAiProvidersOpenaiAnthropicShim from "@pk-nerdsaver-ai/pi-ai/providers/openai-anthropic-shim";
import * as bundledPiAiProvidersOpenaiChatServer from "@pk-nerdsaver-ai/pi-ai/providers/openai-chat-server";
import * as bundledPiAiProvidersOpenaiChatServerSchema from "@pk-nerdsaver-ai/pi-ai/providers/openai-chat-server-schema";
import * as bundledPiAiProvidersOpenaiChatWire from "@pk-nerdsaver-ai/pi-ai/providers/openai-chat-wire";
import * as bundledPiAiProvidersOpenaiCodexRequestTransformer from "@pk-nerdsaver-ai/pi-ai/providers/openai-codex/request-transformer";
import * as bundledPiAiProvidersOpenaiCodexResponseHandler from "@pk-nerdsaver-ai/pi-ai/providers/openai-codex/response-handler";
import * as bundledPiAiProvidersOpenaiCodexResponses from "@pk-nerdsaver-ai/pi-ai/providers/openai-codex-responses";
import * as bundledPiAiProvidersOpenaiCompletions from "@pk-nerdsaver-ai/pi-ai/providers/openai-completions";
import * as bundledPiAiProvidersOpenaiReasoningFallback from "@pk-nerdsaver-ai/pi-ai/providers/openai-reasoning-fallback";
import * as bundledPiAiProvidersOpenaiResponses from "@pk-nerdsaver-ai/pi-ai/providers/openai-responses";
import * as bundledPiAiProvidersOpenaiResponsesServer from "@pk-nerdsaver-ai/pi-ai/providers/openai-responses-server";
import * as bundledPiAiProvidersOpenaiResponsesServerSchema from "@pk-nerdsaver-ai/pi-ai/providers/openai-responses-server-schema";
import * as bundledPiAiProvidersOpenaiResponsesWire from "@pk-nerdsaver-ai/pi-ai/providers/openai-responses-wire";
import * as bundledPiAiProvidersOpenaiShared from "@pk-nerdsaver-ai/pi-ai/providers/openai-shared";
import * as bundledPiAiProvidersPiNativeClient from "@pk-nerdsaver-ai/pi-ai/providers/pi-native-client";
import * as bundledPiAiProvidersPiNativeServer from "@pk-nerdsaver-ai/pi-ai/providers/pi-native-server";
import * as bundledPiAiProvidersRegisterBuiltins from "@pk-nerdsaver-ai/pi-ai/providers/register-builtins";
import * as bundledPiAiProvidersSynthetic from "@pk-nerdsaver-ai/pi-ai/providers/synthetic";
import * as bundledPiAiProvidersTransformMessages from "@pk-nerdsaver-ai/pi-ai/providers/transform-messages";
...
import * as bundledPiAiUsageGoogleAntigravity from "@pk-nerdsaver-ai/pi-ai/usage/google-antigravity";
import * as bundledPiAiUsageKimi from "@pk-nerdsaver-ai/pi-ai/usage/kimi";
import * as bundledPiAiUsageMinimaxCode from "@pk-nerdsaver-ai/pi-ai/usage/minimax-code";
import * as bundledPiAiUsageOllama from "@pk-nerdsaver-ai/pi-ai/usage/ollama";
import * as bundledPiAiUsageOpenaiCodex from "@pk-nerdsaver-ai/pi-ai/usage/openai-codex";
import * as bundledPiAiUsageOpenaiCodexBaseUrl from "@pk-nerdsaver-ai/pi-ai/usage/openai-codex-base-url";
import * as bundledPiAiUsageOpenaiCodexReset from "@pk-nerdsaver-ai/pi-ai/usage/openai-codex-reset";
import * as bundledPiAiUsageOpencodeGo from "@pk-nerdsaver-ai/pi-ai/usage/opencode-go";
import * as bundledPiAiUsageShared from "@pk-nerdsaver-ai/pi-ai/usage/shared";
import * as bundledPiAiUsageZai from "@pk-nerdsaver-ai/pi-ai/usage/zai";
import * as bundledPiAiUtilsAbort from "@pk-nerdsaver-ai/pi-ai/utils/abort";
import * as bundledPiAiUtilsAnthropicAuth from "@pk-nerdsaver-ai/pi-ai/utils/anthropic-auth";
import * as bundledPiAiUtilsBlockSymbols from "@pk-nerdsaver-ai/pi-ai/utils/block-symbols";
import * as bundledPiAiUtilsDeterministicId from "@pk-nerdsaver-ai/pi-ai/utils/deterministic-id";
import * as bundledPiAiUtilsEmptyCompletionRetry from "@pk-nerdsaver-ai/pi-ai/utils/empty-completion-retry";
import * as bundledPiAiUtilsEventStream from "@pk-nerdsaver-ai/pi-ai/utils/event-stream";
import * as bundledPiAiUtilsFoundry from "@pk-nerdsaver-ai/pi-ai/utils/foundry";
import * as bundledPiAiUtilsGoogleValidation from "@pk-nerdsaver-ai/pi-ai/utils/google-validation";
...
import * as bundledPiAiUtilsRetry from "@pk-nerdsaver-ai/pi-ai/utils/retry";
import * as bundledPiAiUtilsRetryAfter from "@pk-nerdsaver-ai/pi-ai/utils/retry-after";
import * as bundledPiAiUtilsSchema from "@pk-nerdsaver-ai/pi-ai/utils/schema";
import * as bundledPiAiUtilsSchemaAdapt from "@pk-nerdsaver-ai/pi-ai/utils/schema/adapt";
import * as bundledPiAiUtilsSchemaCompatibility from "@pk-nerdsaver-ai/pi-ai/utils/schema/compatibility";
import * as bundledPiAiUtilsSchemaDereference from "@pk-nerdsaver-ai/pi-ai/utils/schema/dereference";
import * as bundledPiAiUtilsSchemaDraft from "@pk-nerdsaver-ai/pi-ai/utils/schema/draft";
import * as bundledPiAiUtilsSchemaEquality from "@pk-nerdsaver-ai/pi-ai/utils/schema/equality";
import * as bundledPiAiUtilsSchemaFields from "@pk-nerdsaver-ai/pi-ai/utils/schema/fields";
import * as bundledPiAiUtilsSchemaJsonSchemaValidator from "@pk-nerdsaver-ai/pi-ai/utils/schema/json-schema-validator";
import * as bundledPiAiUtilsSchemaMetaValidator from "@pk-nerdsaver-ai/pi-ai/utils/schema/meta-validator";
import * as bundledPiAiUtilsSchemaNormalize from "@pk-nerdsaver-ai/pi-ai/utils/schema/normalize";
import * as bundledPiAiUtilsSchemaSpill from "@pk-nerdsaver-ai/pi-ai/utils/schema/spill";
import * as bundledPiAiUtilsSchemaStamps from "@pk-nerdsaver-ai/pi-ai/utils/schema/stamps";
import * as bundledPiAiUtilsSchemaStrictToolValidation from "@pk-nerdsaver-ai/pi-ai/utils/schema/strict-tool-validation";
import * as bundledPiAiUtilsSchemaTypes from "@pk-nerdsaver-ai/pi-ai/utils/schema/types";
import * as bundledPiAiUtilsSchemaTypescript from "@pk-nerdsaver-ai/pi-ai/utils/schema/typescript";
import * as bundledPiAiUtilsSchemaWire from "@pk-nerdsaver-ai/pi-ai/utils/schema/wire";
import * as bundledPiAiUtilsSchemaZodDecontaminate from "@pk-nerdsaver-ai/pi-ai/utils/schema/zod-decontaminate";
import * as bundledPiAiUtilsSdkStreamTimeout from "@pk-nerdsaver-ai/pi-ai/utils/sdk-stream-timeout";
import * as bundledPiAiUtilsSseDebug from "@pk-nerdsaver-ai/pi-ai/utils/sse-debug";
import * as bundledPiAiUtilsStreamMarkupHealing from "@pk-nerdsaver-ai/pi-ai/utils/stream-markup-healing";
import * as bundledPiAiUtilsThinkingLoop from "@pk-nerdsaver-ai/pi-ai/utils/thinking-loop";
import * as bundledPiAiUtilsToolChoice from "@pk-nerdsaver-ai/pi-ai/utils/tool-choice";
import * as bundledPiAiUtilsValidation from "@pk-nerdsaver-ai/pi-ai/utils/validation";
import * as bundledPiCodingAgentAsync from "@pk-nerdsaver-ai/pi-coding-agent/async";
import * as bundledPiCodingAgentAsyncJobManager from "@pk-nerdsaver-ai/pi-coding-agent/async/job-manager";
import * as bundledPiCodingAgentAutoresearch from "@pk-nerdsaver-ai/pi-coding-agent/autoresearch";
...
import * as bundledPiCodingAgentAutoresearchToolsLogExperiment from "@pk-nerdsaver-ai/pi-coding-agent/autoresearch/tools/log-experiment";
import * as bundledPiCodingAgentAutoresearchToolsRunExperiment from "@pk-nerdsaver-ai/pi-coding-agent/autoresearch/tools/run-experiment";
import * as bundledPiCodingAgentAutoresearchToolsUpdateNotes from "@pk-nerdsaver-ai/pi-coding-agent/autoresearch/tools/update-notes";
import * as bundledPiCodingAgentAutoresearchTypes from "@pk-nerdsaver-ai/pi-coding-agent/autoresearch/types";
import * as bundledPiCodingAgentCapability from "@pk-nerdsaver-ai/pi-coding-agent/capability";
import * as bundledPiCodingAgentCapabilityContextFile from "@pk-nerdsaver-ai/pi-coding-agent/capability/context-file";
import * as bundledPiCodingAgentCapabilityExtension from "@pk-nerdsaver-ai/pi-coding-agent/capability/extension";
import * as bundledPiCodingAgentCapabilityExtensionModule from "@pk-nerdsaver-ai/pi-coding-agent/capability/extension-module";
import * as bundledPiCodingAgentCapabilityFs from "@pk-nerdsaver-ai/pi-coding-agent/capability/fs";
...
import * as bundledPiCodingAgentCapabilitySettings from "@pk-nerdsaver-ai/pi-coding-agent/capability/settings";
import * as bundledPiCodingAgentCapabilitySkill from "@pk-nerdsaver-ai/pi-coding-agent/capability/skill";
import * as bundledPiCodingAgentCapabilitySlashCommand from "@pk-nerdsaver-ai/pi-coding-agent/capability/slash-command";
import * as bundledPiCodingAgentCapabilitySsh from "@pk-nerdsaver-ai/pi-coding-agent/capability/ssh";
...
import * as bundledPiCodingAgentCliAuthGatewayCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/auth-gateway-cli";
import * as bundledPiCodingAgentCliBenchCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/bench-cli";
import * as bundledPiCodingAgentCliClassifyInstallTarget from "@pk-nerdsaver-ai/pi-coding-agent/cli/classify-install-target";
import * as bundledPiCodingAgentCliClaudeTraceCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/claude-trace-cli";
import * as bundledPiCodingAgentCliCommandsInitXdg from "@pk-nerdsaver-ai/pi-coding-agent/cli/commands/init-xdg";
import * as bundledPiCodingAgentCliCompletionGen from "@pk-nerdsaver-ai/pi-coding-agent/cli/completion-gen";
import * as bundledPiCodingAgentCliConfigCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/config-cli";
import * as bundledPiCodingAgentCliDryBalanceCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/dry-balance-cli";
import * as bundledPiCodingAgentCliExtensionFlags from "@pk-nerdsaver-ai/pi-coding-agent/cli/extension-flags";
import * as bundledPiCodingAgentCliFileProcessor from "@pk-nerdsaver-ai/pi-coding-agent/cli/file-processor";
import * as bundledPiCodingAgentCliFlagTables from "@pk-nerdsaver-ai/pi-coding-agent/cli/flag-tables";
import * as bundledPiCodingAgentCliGalleryCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-cli";
import * as bundledPiCodingAgentCliGalleryFixtures from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures";
import * as bundledPiCodingAgentCliGalleryFixturesAgentic from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/agentic";
import * as bundledPiCodingAgentCliGalleryFixturesCodeintel from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/codeintel";
import * as bundledPiCodingAgentCliGalleryFixturesEdit from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/edit";
import * as bundledPiCodingAgentCliGalleryFixturesFs from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/fs";
import * as bundledPiCodingAgentCliGalleryFixturesInteraction from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/interaction";
import * as bundledPiCodingAgentCliGalleryFixturesMemory from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/memory";
import * as bundledPiCodingAgentCliGalleryFixturesMisc from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/misc";
import * as bundledPiCodingAgentCliGalleryFixturesSearch from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/search";
import * as bundledPiCodingAgentCliGalleryFixturesShell from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/shell";
import * as bundledPiCodingAgentCliGalleryFixturesTypes from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/types";
import * as bundledPiCodingAgentCliGalleryFixturesWeb from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-fixtures/web";
import * as bundledPiCodingAgentCliGalleryScreenshot from "@pk-nerdsaver-ai/pi-coding-agent/cli/gallery-screenshot";
import * as bundledPiCodingAgentCliGcCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/gc-cli";
import * as bundledPiCodingAgentCliGrepCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/grep-cli";
...
import * as bundledPiCodingAgentCliReadCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/read-cli";
import * as bundledPiCodingAgentCliSessionPicker from "@pk-nerdsaver-ai/pi-coding-agent/cli/session-picker";
import * as bundledPiCodingAgentCliSetupCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/setup-cli";
import * as bundledPiCodingAgentCliSetupModelPicker from "@pk-nerdsaver-ai/pi-coding-agent/cli/setup-model-picker";
import * as bundledPiCodingAgentCliShellCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/shell-cli";
import * as bundledPiCodingAgentCliSshCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/ssh-cli";
import * as bundledPiCodingAgentCliStartupCwd from "@pk-nerdsaver-ai/pi-coding-agent/cli/startup-cwd";
import * as bundledPiCodingAgentCliStatsCli from "@pk-nerdsaver-ai/pi-coding-agent/cli/stats-cli";
...
import * as bundledPiCodingAgentCommandsConfig from "@pk-nerdsaver-ai/pi-coding-agent/commands/config";
import * as bundledPiCodingAgentCommandsDryBalance from "@pk-nerdsaver-ai/pi-coding-agent/commands/dry-balance";
import * as bundledPiCodingAgentCommandsGallery from "@pk-nerdsaver-ai/pi-coding-agent/commands/gallery";
import * as bundledPiCodingAgentCommandsGc from "@pk-nerdsaver-ai/pi-coding-agent/commands/gc";
import * as bundledPiCodingAgentCommandsGrep from "@pk-nerdsaver-ai/pi-coding-agent/commands/grep";
import * as bundledPiCodingAgentCommandsGrievances from "@pk-nerdsaver-ai/pi-coding-agent/commands/grievances";
import * as bundledPiCodingAgentCommandsInstall from "@pk-nerdsaver-ai/pi-coding-agent/commands/install";
...
import * as bundledPiCodingAgentCommandsSsh from "@pk-nerdsaver-ai/pi-coding-agent/commands/ssh";
import * as bundledPiCodingAgentCommandsStats from "@pk-nerdsaver-ai/pi-coding-agent/commands/stats";
import * as bundledPiCodingAgentCommandsTinyModels from "@pk-nerdsaver-ai/pi-coding-agent/commands/tiny-models";
import * as bundledPiCodingAgentCommandsToken from "@pk-nerdsaver-ai/pi-coding-agent/commands/token";
import * as bundledPiCodingAgentCommandsTtsr from "@pk-nerdsaver-ai/pi-coding-agent/commands/ttsr";
import * as bundledPiCodingAgentCommandsUpdate from "@pk-nerdsaver-ai/pi-coding-agent/commands/update";
import * as bundledPiCodingAgentCommandsUsage from "@pk-nerdsaver-ai/pi-coding-agent/commands/usage";
import * as bundledPiCodingAgentCommandsWebSearch from "@pk-nerdsaver-ai/pi-coding-agent/commands/web-search";
import * as bundledPiCodingAgentCommandsWorktree from "@pk-nerdsaver-ai/pi-coding-agent/commands/worktree";
import * as bundledPiCodingAgentCommit from "@pk-nerdsaver-ai/pi-coding-agent/commit";
import * as bundledPiCodingAgentCommitAgentic from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic";
import * as bundledPiCodingAgentCommitAgenticAgent from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/agent";
import * as bundledPiCodingAgentCommitAgenticFallback from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/fallback";
import * as bundledPiCodingAgentCommitAgenticState from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/state";
import * as bundledPiCodingAgentCommitAgenticTools from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools";
import * as bundledPiCodingAgentCommitAgenticToolsAnalyzeFile from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/analyze-file";
import * as bundledPiCodingAgentCommitAgenticToolsGitFileDiff from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/git-file-diff";
import * as bundledPiCodingAgentCommitAgenticToolsGitHunk from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/git-hunk";
import * as bundledPiCodingAgentCommitAgenticToolsGitOverview from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/git-overview";
import * as bundledPiCodingAgentCommitAgenticToolsProposeChangelog from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/propose-changelog";
import * as bundledPiCodingAgentCommitAgenticToolsProposeCommit from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/propose-commit";
import * as bundledPiCodingAgentCommitAgenticToolsRecentCommits from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/recent-commits";
import * as bundledPiCodingAgentCommitAgenticToolsSchemas from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/schemas";
import * as bundledPiCodingAgentCommitAgenticToolsSplitCommit from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/tools/split-commit";
import * as bundledPiCodingAgentCommitAgenticTopoSort from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/topo-sort";
import * as bundledPiCodingAgentCommitAgenticTrivial from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/trivial";
import * as bundledPiCodingAgentCommitAgenticValidation from "@pk-nerdsaver-ai/pi-coding-agent/commit/agentic/validation";
import * as bundledPiCodingAgentCommitAnalysis from "@pk-nerdsaver-ai/pi-coding-agent/commit/analysis";
import * as bundledPiCodingAgentCommitAnalysisConventional from "@pk-nerdsaver-ai/pi-coding-agent/commit/analysis/conventional";
import * as bundledPiCodingAgentCommitAnalysisScope from "@pk-nerdsaver-ai/pi-coding-agent/commit/analysis/scope";
import * as bundledPiCodingAgentCommitAnalysisSummary from "@pk-nerdsaver-ai/pi-coding-agent/commit/analysis/summary";
import * as bundledPiCodingAgentCommitAnalysisValidation from "@pk-nerdsaver-ai/pi-coding-agent/commit/analysis/validation";
import * as bundledPiCodingAgentCommitChangelog from "@pk-nerdsaver-ai/pi-coding-agent/commit/changelog";
import * as bundledPiCodingAgentCommitChangelogDetect from "@pk-nerdsaver-ai/pi-coding-agent/commit/changelog/detect";
import * as bundledPiCodingAgentCommitChangelogGenerate from "@pk-nerdsaver-ai/pi-coding-agent/commit/changelog/generate";
import * as bundledPiCodingAgentCommitChangelogParse from "@pk-nerdsaver-ai/pi-coding-agent/commit/changelog/parse";
import * as bundledPiCodingAgentCommitCli from "@pk-nerdsaver-ai/pi-coding-agent/commit/cli";
import * as bundledPiCodingAgentCommitGitDiff from "@pk-nerdsaver-ai/pi-coding-agent/commit/git/diff";
import * as bundledPiCodingAgentCommitMapReduce from "@pk-nerdsaver-ai/pi-coding-agent/commit/map-reduce";
import * as bundledPiCodingAgentCommitMapReduceMapPhase from "@pk-nerdsaver-ai/pi-coding-agent/commit/map-reduce/map-phase";
import * as bundledPiCodingAgentCommitMapReduceReducePhase from "@pk-nerdsaver-ai/pi-coding-agent/commit/map-reduce/reduce-phase";
import * as bundledPiCodingAgentCommitMapReduceUtils from "@pk-nerdsaver-ai/pi-coding-agent/commit/map-reduce/utils";
import * as bundledPiCodingAgentCommitMessage from "@pk-nerdsaver-ai/pi-coding-agent/commit/message";
import * as bundledPiCodingAgentCommitModelSelection from "@pk-nerdsaver-ai/pi-coding-agent/commit/model-selection";
import * as bundledPiCodingAgentCommitPipeline from "@pk-nerdsaver-ai/pi-coding-agent/commit/pipeline";
import * as bundledPiCodingAgentCommitSharedLlm from "@pk-nerdsaver-ai/pi-coding-agent/commit/shared-llm";
import * as bundledPiCodingAgentCommitTypes from "@pk-nerdsaver-ai/pi-coding-agent/commit/types";
import * as bundledPiCodingAgentCommitUtils from "@pk-nerdsaver-ai/pi-coding-agent/commit/utils";
import * as bundledPiCodingAgentCommitUtilsExclusions from "@pk-nerdsaver-ai/pi-coding-agent/commit/utils/exclusions";
...
import * as bundledPiCodingAgentDapSession from "@pk-nerdsaver-ai/pi-coding-agent/dap/session";
import * as bundledPiCodingAgentDapTypes from "@pk-nerdsaver-ai/pi-coding-agent/dap/types";
import * as bundledPiCodingAgentDebug from "@pk-nerdsaver-ai/pi-coding-agent/debug";
import * as bundledPiCodingAgentDebugLogFormatting from "@pk-nerdsaver-ai/pi-coding-agent/debug/log-formatting";
import * as bundledPiCodingAgentDebugLogViewer from "@pk-nerdsaver-ai/pi-coding-agent/debug/log-viewer";
import * as bundledPiCodingAgentDebugProfiler from "@pk-nerdsaver-ai/pi-coding-agent/debug/profiler";
import * as bundledPiCodingAgentDebugProtocolProbe from "@pk-nerdsaver-ai/pi-coding-agent/debug/protocol-probe";
import * as bundledPiCodingAgentDebugRawSse from "@pk-nerdsaver-ai/pi-coding-agent/debug/raw-sse";
import * as bundledPiCodingAgentDebugRawSseBuffer from "@pk-nerdsaver-ai/pi-coding-agent/debug/raw-sse-buffer";
import * as bundledPiCodingAgentDebugRemoteDebugger from "@pk-nerdsaver-ai/pi-coding-agent/debug/remote-debugger";
import * as bundledPiCodingAgentDebugReportBundle from "@pk-nerdsaver-ai/pi-coding-agent/debug/report-bundle";
import * as bundledPiCodingAgentDebugSystemInfo from "@pk-nerdsaver-ai/pi-coding-agent/debug/system-info";
import * as bundledPiCodingAgentDebugTerminalInfo from "@pk-nerdsaver-ai/pi-coding-agent/debug/terminal-info";
import * as bundledPiCodingAgentDiscovery from "@pk-nerdsaver-ai/pi-coding-agent/discovery";
import * as bundledPiCodingAgentDiscoveryAgents from "@pk-nerdsaver-ai/pi-coding-agent/discovery/agents";
import * as bundledPiCodingAgentDiscoveryAgentsMd from "@pk-nerdsaver-ai/pi-coding-agent/discovery/agents-md";
import * as bundledPiCodingAgentDiscoveryAtImports from "@pk-nerdsaver-ai/pi-coding-agent/discovery/at-imports";
import * as bundledPiCodingAgentDiscoveryBuiltin from "@pk-nerdsaver-ai/pi-coding-agent/discovery/builtin";
import * as bundledPiCodingAgentDiscoveryBuiltinDefaults from "@pk-nerdsaver-ai/pi-coding-agent/discovery/builtin-defaults";
import * as bundledPiCodingAgentDiscoveryClaude from "@pk-nerdsaver-ai/pi-coding-agent/discovery/claude";
import * as bundledPiCodingAgentDiscoveryClaudePlugins from "@pk-nerdsaver-ai/pi-coding-agent/discovery/claude-plugins";
import * as bundledPiCodingAgentDiscoveryCline from "@pk-nerdsaver-ai/pi-coding-agent/discovery/cline";
import * as bundledPiCodingAgentDiscoveryCodex from "@pk-nerdsaver-ai/pi-coding-agent/discovery/codex";
import * as bundledPiCodingAgentDiscoveryCursor from "@pk-nerdsaver-ai/pi-coding-agent/discovery/cursor";
import * as bundledPiCodingAgentDiscoveryGemini from "@pk-nerdsaver-ai/pi-coding-agent/discovery/gemini";
...
import * as bundledPiCodingAgentDiscoveryPluginDirRoots from "@pk-nerdsaver-ai/pi-coding-agent/discovery/plugin-dir-roots";
import * as bundledPiCodingAgentDiscoverySsh from "@pk-nerdsaver-ai/pi-coding-agent/discovery/ssh";
import * as bundledPiCodingAgentDiscoverySubstitutePluginRoot from "@pk-nerdsaver-ai/pi-coding-agent/discovery/substitute-plugin-root";
import * as bundledPiCodingAgentDiscoveryVscode from "@pk-nerdsaver-ai/pi-coding-agent/discovery/vscode";
import * as bundledPiCodingAgentDiscoveryWindsurf from "@pk-nerdsaver-ai/pi-coding-agent/discovery/windsurf";
import * as bundledPiCodingAgentEdit from "@pk-nerdsaver-ai/pi-coding-agent/edit";
import * as bundledPiCodingAgentEditDiff from "@pk-nerdsaver-ai/pi-coding-agent/edit/diff";
import * as bundledPiCodingAgentEditFileSnapshotStore from "@pk-nerdsaver-ai/pi-coding-agent/edit/file-snapshot-store";
import * as bundledPiCodingAgentEditModesApplyPatch from "@pk-nerdsaver-ai/pi-coding-agent/edit/modes/apply-patch";
import * as bundledPiCodingAgentEditModesPatch from "@pk-nerdsaver-ai/pi-coding-agent/edit/modes/patch";
import * as bundledPiCodingAgentEditModesReplace from "@pk-nerdsaver-ai/pi-coding-agent/edit/modes/replace";
import * as bundledPiCodingAgentEditNormalize from "@pk-nerdsaver-ai/pi-coding-agent/edit/normalize";
import * as bundledPiCodingAgentEditNotebook from "@pk-nerdsaver-ai/pi-coding-agent/edit/notebook";
import * as bundledPiCodingAgentEditReadFile from "@pk-nerdsaver-ai/pi-coding-agent/edit/read-file";
import * as bundledPiCodingAgentEditRenderer from "@pk-nerdsaver-ai/pi-coding-agent/edit/renderer";
import * as bundledPiCodingAgentEditStreaming from "@pk-nerdsaver-ai/pi-coding-agent/edit/streaming";
import * as bundledPiCodingAgentEval from "@pk-nerdsaver-ai/pi-coding-agent/eval";
import * as bundledPiCodingAgentEvalJsContextManager from "@pk-nerdsaver-ai/pi-coding-agent/eval/js/context-manager";
import * as bundledPiCodingAgentEvalJsExecutor from "@pk-nerdsaver-ai/pi-coding-agent/eval/js/executor";
import * as bundledPiCodingAgentEvalJsToolBridge from "@pk-nerdsaver-ai/pi-coding-agent/eval/js/tool-bridge";
import * as bundledPiCodingAgentEvalJsWorkerCore from "@pk-nerdsaver-ai/pi-coding-agent/eval/js/worker-core";
import * as bundledPiCodingAgentEvalJsWorkerProtocol from "@pk-nerdsaver-ai/pi-coding-agent/eval/js/worker-protocol";
import * as bundledPiCodingAgentEvalPyDisplay from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/display";
import * as bundledPiCodingAgentEvalPyExecutor from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/executor";
import * as bundledPiCodingAgentEvalPyKernel from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/kernel";
import * as bundledPiCodingAgentEvalPyPrelude from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/prelude";
import * as bundledPiCodingAgentEvalPyRuntime from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/runtime";
import * as bundledPiCodingAgentEvalPySpawnOptions from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/spawn-options";
import * as bundledPiCodingAgentEvalPyToolBridge from "@pk-nerdsaver-ai/pi-coding-agent/eval/py/tool-bridge";
import * as bundledPiCodingAgentExa from "@pk-nerdsaver-ai/pi-coding-agent/exa";
import * as bundledPiCodingAgentExaMcpClient from "@pk-nerdsaver-ai/pi-coding-agent/exa/mcp-client";
import * as bundledPiCodingAgentExaTypes from "@pk-nerdsaver-ai/pi-coding-agent/exa/types";
import * as bundledPiCodingAgentExecBashExecutor from "@pk-nerdsaver-ai/pi-coding-agent/exec/bash-executor";
import * as bundledPiCodingAgentExecExec from "@pk-nerdsaver-ai/pi-coding-agent/exec/exec";
import * as bundledPiCodingAgentExecNonInteractiveEnv from "@pk-nerdsaver-ai/pi-coding-agent/exec/non-interactive-env";
import * as bundledPiCodingAgentExportCustomShare from "@pk-nerdsaver-ai/pi-coding-agent/export/custom-share";
import * as bundledPiCodingAgentExportHtml from "@pk-nerdsaver-ai/pi-coding-agent/export/html";
import * as bundledPiCodingAgentExportHtmlWebPalette from "@pk-nerdsaver-ai/pi-coding-agent/export/html/web-palette";
import * as bundledPiCodingAgentExportShare from "@pk-nerdsaver-ai/pi-coding-agent/export/share";
import * as bundledPiCodingAgentExportTtsr from "@pk-nerdsaver-ai/pi-coding-agent/export/ttsr";
import * as bundledPiCodingAgentExtensibilityCustomCommands from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-commands";
import * as bundledPiCodingAgentExtensibilityCustomCommandsBundledCiGreen from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-commands/bundled/ci-green";
import * as bundledPiCodingAgentExtensibilityCustomCommandsBundledReview from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-commands/bundled/review";
import * as bundledPiCodingAgentExtensibilityCustomCommandsLoader from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-commands/loader";
import * as bundledPiCodingAgentExtensibilityCustomCommandsTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-commands/types";
import * as bundledPiCodingAgentExtensibilityCustomTools from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-tools";
import * as bundledPiCodingAgentExtensibilityCustomToolsLoader from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-tools/loader";
import * as bundledPiCodingAgentExtensibilityCustomToolsTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-tools/types";
import * as bundledPiCodingAgentExtensibilityCustomToolsWrapper from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/custom-tools/wrapper";
import * as bundledPiCodingAgentExtensibilityExtensions from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions";
import * as bundledPiCodingAgentExtensibilityExtensionsCompactHandler from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/compact-handler";
import * as bundledPiCodingAgentExtensibilityExtensionsGetCommandsHandler from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/get-commands-handler";
import * as bundledPiCodingAgentExtensibilityExtensionsLoader from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/loader";
import * as bundledPiCodingAgentExtensibilityExtensionsModelApi from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/model-api";
import * as bundledPiCodingAgentExtensibilityExtensionsRunner from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/runner";
import * as bundledPiCodingAgentExtensibilityExtensionsTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/types";
import * as bundledPiCodingAgentExtensibilityExtensionsWrapper from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/wrapper";
import * as bundledPiCodingAgentExtensibilityHooks from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/hooks";
import * as bundledPiCodingAgentExtensibilityHooksLoader from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/hooks/loader";
import * as bundledPiCodingAgentExtensibilityHooksRunner from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/hooks/runner";
import * as bundledPiCodingAgentExtensibilityHooksToolWrapper from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/hooks/tool-wrapper";
import * as bundledPiCodingAgentExtensibilityHooksTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/hooks/types";
import * as bundledPiCodingAgentExtensibilityLegacyPiAiShim from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/legacy-pi-ai-shim";
import * as bundledPiCodingAgentExtensibilityLegacyPiCodingAgentShim from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
import * as bundledPiCodingAgentExtensibilityPlugins from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins";
import * as bundledPiCodingAgentExtensibilityPluginsDoctor from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/doctor";
import * as bundledPiCodingAgentExtensibilityPluginsGitUrl from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/git-url";
import * as bundledPiCodingAgentExtensibilityPluginsInstaller from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/installer";
import * as bundledPiCodingAgentExtensibilityPluginsLegacyPiBundledKeys from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/legacy-pi-bundled-keys";
import * as bundledPiCodingAgentExtensibilityPluginsLegacyPiBundledRegistry from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/legacy-pi-bundled-registry";
...
import * as bundledPiCodingAgentExtensibilityPluginsMarketplaceManager from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/marketplace/manager";
import * as bundledPiCodingAgentExtensibilityPluginsMarketplaceRegistry from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/marketplace/registry";
import * as bundledPiCodingAgentExtensibilityPluginsMarketplaceSourceResolver from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/marketplace/source-resolver";
import * as bundledPiCodingAgentExtensibilityPluginsMarketplaceTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/marketplace/types";
import * as bundledPiCodingAgentExtensibilityPluginsMarketplaceAutoUpdate from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/marketplace-auto-update";
import * as bundledPiCodingAgentExtensibilityPluginsParser from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/parser";
import * as bundledPiCodingAgentExtensibilityPluginsRuntimeConfig from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/runtime-config";
import * as bundledPiCodingAgentExtensibilityPluginsTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/plugins/types";
import * as bundledPiCodingAgentExtensibilitySessionHandlerTypes from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/session-handler-types";
import * as bundledPiCodingAgentExtensibilitySharedEvents from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/shared-events";
import * as bundledPiCodingAgentExtensibilitySkills from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/skills";
import * as bundledPiCodingAgentExtensibilitySlashCommands from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/slash-commands";
import * as bundledPiCodingAgentExtensibilityToolEventInput from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/tool-event-input";
...
import * as bundledPiCodingAgentHindsightClient from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/client";
import * as bundledPiCodingAgentHindsightConfig from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/config";
import * as bundledPiCodingAgentHindsightContent from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/content";
import * as bundledPiCodingAgentHindsightMentalModels from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/mental-models";
import * as bundledPiCodingAgentHindsightState from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/state";
import * as bundledPiCodingAgentHindsightTranscript from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/transcript";
import * as bundledPiCodingAgentInternalUrls from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls";
import * as bundledPiCodingAgentInternalUrlsAgentProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/agent-protocol";
import * as bundledPiCodingAgentInternalUrlsArtifactProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/artifact-protocol";
import * as bundledPiCodingAgentInternalUrlsDocsIndex from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/docs-index";
import * as bundledPiCodingAgentInternalUrlsFilesystemResource from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/filesystem-resource";
import * as bundledPiCodingAgentInternalUrlsHistoryProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/history-protocol";
import * as bundledPiCodingAgentInternalUrlsIssuePrProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/issue-pr-protocol";
import * as bundledPiCodingAgentInternalUrlsJsonQuery from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/json-query";
import * as bundledPiCodingAgentInternalUrlsLocalProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/local-protocol";
import * as bundledPiCodingAgentInternalUrlsMcpProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/mcp-protocol";
import * as bundledPiCodingAgentInternalUrlsMemoryProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/memory-protocol";
import * as bundledPiCodingAgentInternalUrlsOmpProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/omp-protocol";
import * as bundledPiCodingAgentInternalUrlsParse from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/parse";
import * as bundledPiCodingAgentInternalUrlsRegistryHelpers from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/registry-helpers";
import * as bundledPiCodingAgentInternalUrlsRouter from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/router";
import * as bundledPiCodingAgentInternalUrlsRuleProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/rule-protocol";
import * as bundledPiCodingAgentInternalUrlsSkillProtocol from "@pk-nerdsaver-ai/pi-coding-agent/internal-urls/skill-protocol";
...
import * as bundledPiCodingAgentLspClientsBiomeClient from "@pk-nerdsaver-ai/pi-coding-agent/lsp/clients/biome-client";
import * as bundledPiCodingAgentLspClientsLspLinterClient from "@pk-nerdsaver-ai/pi-coding-agent/lsp/clients/lsp-linter-client";
import * as bundledPiCodingAgentLspClientsSwiftlintClient from "@pk-nerdsaver-ai/pi-coding-agent/lsp/clients/swiftlint-client";
import * as bundledPiCodingAgentLspConfig from "@pk-nerdsaver-ai/pi-coding-agent/lsp/config";
import * as bundledPiCodingAgentLspDiagnosticsLedger from "@pk-nerdsaver-ai/pi-coding-agent/lsp/diagnostics-ledger";
import * as bundledPiCodingAgentLspEdits from "@pk-nerdsaver-ai/pi-coding-agent/lsp/edits";
import * as bundledPiCodingAgentLspFormatOptions from "@pk-nerdsaver-ai/pi-coding-agent/lsp/format-options";
import * as bundledPiCodingAgentLspLspmux from "@pk-nerdsaver-ai/pi-coding-agent/lsp/lspmux";
import * as bundledPiCodingAgentLspRender from "@pk-nerdsaver-ai/pi-coding-agent/lsp/render";
...
import * as bundledPiCodingAgentMcp from "@pk-nerdsaver-ai/pi-coding-agent/mcp";
...
import * as bundledPiCodingAgentMcpSmitheryRegistry from "@pk-nerdsaver-ai/pi-coding-agent/mcp/smithery-registry";
import * as bundledPiCodingAgentMcpStartupEvents from "@pk-nerdsaver-ai/pi-coding-agent/mcp/startup-events";
import * as bundledPiCodingAgentMcpTimeout from "@pk-nerdsaver-ai/pi-coding-agent/mcp/timeout";
import * as bundledPiCodingAgentMcpToolBridge from "@pk-nerdsaver-ai/pi-coding-agent/mcp/tool-bridge";
import * as bundledPiCodingAgentMcpToolCache from "@pk-nerdsaver-ai/pi-coding-agent/mcp/tool-cache";
import * as bundledPiCodingAgentMcpTransports from "@pk-nerdsaver-ai/pi-coding-agent/mcp/transports";
import * as bundledPiCodingAgentMcpTransportsHttp from "@pk-nerdsaver-ai/pi-coding-agent/mcp/transports/http";
import * as bundledPiCodingAgentMcpTransportsStdio from "@pk-nerdsaver-ai/pi-coding-agent/mcp/transports/stdio";
import * as bundledPiCodingAgentMcpTypes from "@pk-nerdsaver-ai/pi-coding-agent/mcp/types";
import * as bundledPiCodingAgentMemories from "@pk-nerdsaver-ai/pi-coding-agent/memories";
import * as bundledPiCodingAgentMemoriesStorage from "@pk-nerdsaver-ai/pi-coding-agent/memories/storage";
import * as bundledPiCodingAgentMemoryBackend from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend";
import * as bundledPiCodingAgentMemoryBackendLocalBackend from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend/local-backend";
import * as bundledPiCodingAgentMemoryBackendOffBackend from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend/off-backend";
import * as bundledPiCodingAgentMemoryBackendResolve from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend/resolve";
import * as bundledPiCodingAgentMemoryBackendRuntime from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend/runtime";
import * as bundledPiCodingAgentMemoryBackendTypes from "@pk-nerdsaver-ai/pi-coding-agent/memory-backend/types";
import * as bundledPiCodingAgentModes from "@pk-nerdsaver-ai/pi-coding-agent/modes";
import * as bundledPiCodingAgentModesAcp from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp";
import * as bundledPiCodingAgentModesAcpAcpAgent from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp/acp-agent";
import * as bundledPiCodingAgentModesAcpAcpClientBridge from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp/acp-client-bridge";
import * as bundledPiCodingAgentModesAcpAcpEventMapper from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp/acp-event-mapper";
import * as bundledPiCodingAgentModesAcpAcpMode from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp/acp-mode";
import * as bundledPiCodingAgentModesAcpTerminalAuth from "@pk-nerdsaver-ai/pi-coding-agent/modes/acp/terminal-auth";
import * as bundledPiCodingAgentModesComponents from "@pk-nerdsaver-ai/pi-coding-agent/modes/components";
...
import * as bundledPiCodingAgentModesComponentsBashExecution from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/bash-execution";
import * as bundledPiCodingAgentModesComponentsBorderedLoader from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/bordered-loader";
import * as bundledPiCodingAgentModesComponentsBtwPanel from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/btw-panel";
import * as bundledPiCodingAgentModesComponentsCacheInvalidationMarker from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/cache-invalidation-marker";
import * as bundledPiCodingAgentModesComponentsChatBlock from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/chat-block";
import * as bundledPiCodingAgentModesComponentsChatTranscriptBuilder from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/chat-transcript-builder";
import * as bundledPiCodingAgentModesComponentsCollabPromptMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/collab-prompt-message";
import * as bundledPiCodingAgentModesComponentsCompactionSummaryMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/compaction-summary-message";
import * as bundledPiCodingAgentModesComponentsCopySelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/copy-selector";
import * as bundledPiCodingAgentModesComponentsCountdownTimer from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/countdown-timer";
import * as bundledPiCodingAgentModesComponentsCustomEditor from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/custom-editor";
import * as bundledPiCodingAgentModesComponentsCustomMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/custom-message";
import * as bundledPiCodingAgentModesComponentsDiff from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/diff";
import * as bundledPiCodingAgentModesComponentsDynamicBorder from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/dynamic-border";
import * as bundledPiCodingAgentModesComponentsErrorBanner from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/error-banner";
import * as bundledPiCodingAgentModesComponentsEvalExecution from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/eval-execution";
import * as bundledPiCodingAgentModesComponentsExecutionShared from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/execution-shared";
import * as bundledPiCodingAgentModesComponentsExtensions from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions";
import * as bundledPiCodingAgentModesComponentsExtensionsExtensionDashboard from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions/extension-dashboard";
import * as bundledPiCodingAgentModesComponentsExtensionsExtensionList from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions/extension-list";
import * as bundledPiCodingAgentModesComponentsExtensionsInspectorPanel from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions/inspector-panel";
import * as bundledPiCodingAgentModesComponentsExtensionsStateManager from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions/state-manager";
import * as bundledPiCodingAgentModesComponentsExtensionsTypes from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/extensions/types";
import * as bundledPiCodingAgentModesComponentsFooter from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/footer";
import * as bundledPiCodingAgentModesComponentsHistorySearch from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/history-search";
import * as bundledPiCodingAgentModesComponentsHookEditor from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/hook-editor";
import * as bundledPiCodingAgentModesComponentsHookInput from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/hook-input";
import * as bundledPiCodingAgentModesComponentsHookMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/hook-message";
import * as bundledPiCodingAgentModesComponentsHookSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/hook-selector";
import * as bundledPiCodingAgentModesComponentsKeybindingHints from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/keybinding-hints";
import * as bundledPiCodingAgentModesComponentsLateDiagnosticsMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/late-diagnostics-message";
import * as bundledPiCodingAgentModesComponentsLoginDialog from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/login-dialog";
import * as bundledPiCodingAgentModesComponentsLogoutAccountSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/logout-account-selector";
import * as bundledPiCodingAgentModesComponentsMcpAddWizard from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/mcp-add-wizard";
import * as bundledPiCodingAgentModesComponentsMessageFrame from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/message-frame";
import * as bundledPiCodingAgentModesComponentsModelSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/model-selector";
import * as bundledPiCodingAgentModesComponentsMoveOverlay from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/move-overlay";
import * as bundledPiCodingAgentModesComponentsOauthSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/oauth-selector";
import * as bundledPiCodingAgentModesComponentsOmfgPanel from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/omfg-panel";
import * as bundledPiCodingAgentModesComponentsOverlayBox from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/overlay-box";
import * as bundledPiCodingAgentModesComponentsPlanReviewOverlay from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/plan-review-overlay";
import * as bundledPiCodingAgentModesComponentsPlanToc from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/plan-toc";
import * as bundledPiCodingAgentModesComponentsPluginSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/plugin-selector";
import * as bundledPiCodingAgentModesComponentsPluginSettings from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/plugin-settings";
import * as bundledPiCodingAgentModesComponentsQueueModeSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/queue-mode-selector";
import * as bundledPiCodingAgentModesComponentsReadToolGroup from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/read-tool-group";
import * as bundledPiCodingAgentModesComponentsResetUsageSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/reset-usage-selector";
import * as bundledPiCodingAgentModesComponentsSegmentTrack from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/segment-track";
import * as bundledPiCodingAgentModesComponentsSelectListMouseRouting from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/select-list-mouse-routing";
import * as bundledPiCodingAgentModesComponentsSelectorHelpers from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/selector-helpers";
import * as bundledPiCodingAgentModesComponentsSessionSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/session-selector";
import * as bundledPiCodingAgentModesComponentsSettingsDefs from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/settings-defs";
import * as bundledPiCodingAgentModesComponentsSettingsSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/settings-selector";
import * as bundledPiCodingAgentModesComponentsShowImagesSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/show-images-selector";
import * as bundledPiCodingAgentModesComponentsSkillMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/skill-message";
import * as bundledPiCodingAgentModesComponentsSnapcompactShapePreview from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/snapcompact-shape-preview";
import * as bundledPiCodingAgentModesComponentsStatusLine from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line";
import * as bundledPiCodingAgentModesComponentsStatusLineComponent from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/component";
import * as bundledPiCodingAgentModesComponentsStatusLineContextThresholds from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/context-thresholds";
import * as bundledPiCodingAgentModesComponentsStatusLineGitUtils from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/git-utils";
import * as bundledPiCodingAgentModesComponentsStatusLinePresets from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/presets";
import * as bundledPiCodingAgentModesComponentsStatusLineSegments from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/segments";
import * as bundledPiCodingAgentModesComponentsStatusLineSeparators from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/separators";
import * as bundledPiCodingAgentModesComponentsStatusLineTokenRate from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/token-rate";
import * as bundledPiCodingAgentModesComponentsStatusLineTypes from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/status-line/types";
import * as bundledPiCodingAgentModesComponentsThemeSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/theme-selector";
import * as bundledPiCodingAgentModesComponentsThinkingSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/thinking-selector";
import * as bundledPiCodingAgentModesComponentsTinyTitleDownloadProgress from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/tiny-title-download-progress";
import * as bundledPiCodingAgentModesComponentsTodoReminder from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/todo-reminder";
import * as bundledPiCodingAgentModesComponentsToolExecution from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/tool-execution";
import * as bundledPiCodingAgentModesComponentsTranscriptContainer from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/transcript-container";
import * as bundledPiCodingAgentModesComponentsTreeSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/tree-selector";
import * as bundledPiCodingAgentModesComponentsTtsrNotification from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/ttsr-notification";
import * as bundledPiCodingAgentModesComponentsUsageRow from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/usage-row";
import * as bundledPiCodingAgentModesComponentsUserMessage from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/user-message";
import * as bundledPiCodingAgentModesComponentsUserMessageSelector from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/user-message-selector";
import * as bundledPiCodingAgentModesComponentsVisualTruncate from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/visual-truncate";
import * as bundledPiCodingAgentModesComponentsWelcome from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/welcome";
import * as bundledPiCodingAgentModesControllersBtwController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/btw-controller";
import * as bundledPiCodingAgentModesControllersCommandController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/command-controller";
import * as bundledPiCodingAgentModesControllersCommandControllerShared from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/command-controller-shared";
import * as bundledPiCodingAgentModesControllersEventController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/event-controller";
import * as bundledPiCodingAgentModesControllersExtensionUiController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/extension-ui-controller";
import * as bundledPiCodingAgentModesControllersInputController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/input-controller";
import * as bundledPiCodingAgentModesControllersMcpCommandController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/mcp-command-controller";
import * as bundledPiCodingAgentModesControllersOmfgController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/omfg-controller";
import * as bundledPiCodingAgentModesControllersOmfgRule from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/omfg-rule";
import * as bundledPiCodingAgentModesControllersSelectorController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/selector-controller";
import * as bundledPiCodingAgentModesControllersSessionFocusController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/session-focus-controller";
import * as bundledPiCodingAgentModesControllersSshCommandController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/ssh-command-controller";
import * as bundledPiCodingAgentModesControllersStreamingReveal from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/streaming-reveal";
import * as bundledPiCodingAgentModesControllersTanCommandController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/tan-command-controller";
import * as bundledPiCodingAgentModesControllersTodoCommandController from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/todo-command-controller";
import * as bundledPiCodingAgentModesControllersToolArgsReveal from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/tool-args-reveal";
import * as bundledPiCodingAgentModesEmojiAutocomplete from "@pk-nerdsaver-ai/pi-coding-agent/modes/emoji-autocomplete";
import * as bundledPiCodingAgentModesGradientHighlight from "@pk-nerdsaver-ai/pi-coding-agent/modes/gradient-highlight";
import * as bundledPiCodingAgentModesImageReferences from "@pk-nerdsaver-ai/pi-coding-agent/modes/image-references";
...
import * as bundledPiCodingAgentModesRpcHostUris from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/host-uris";
import * as bundledPiCodingAgentModesRpcRpcClient from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/rpc-client";
import * as bundledPiCodingAgentModesRpcRpcMode from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/rpc-mode";
import * as bundledPiCodingAgentModesRpcRpcSubagents from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/rpc-subagents";
import * as bundledPiCodingAgentModesRpcRpcTypes from "@pk-nerdsaver-ai/pi-coding-agent/modes/rpc/rpc-types";
import * as bundledPiCodingAgentModesRunningSubagentBadge from "@pk-nerdsaver-ai/pi-coding-agent/modes/running-subagent-badge";
import * as bundledPiCodingAgentModesRuntimeInit from "@pk-nerdsaver-ai/pi-coding-agent/modes/runtime-init";
import * as bundledPiCodingAgentModesSessionObserverRegistry from "@pk-nerdsaver-ai/pi-coding-agent/modes/session-observer-registry";
import * as bundledPiCodingAgentModesSetupVersion from "@pk-nerdsaver-ai/pi-coding-agent/modes/setup-version";
import * as bundledPiCodingAgentModesSetupWizard from "@pk-nerdsaver-ai/pi-coding-agent/modes/setup-wizard";
import * as bundledPiCodingAgentModesSetupWizardLazy from "@pk-nerdsaver-ai/pi-coding-agent/modes/setup-wizard/lazy";
import * as bundledPiCodingAgentModesSetupWizardStartupSplash from "@pk-nerdsaver-ai/pi-coding-agent/modes/setup-wizard/startup-splash";
import * as bundledPiCodingAgentModesSetupWizardWizardOverlay from "@pk-nerdsaver-ai/pi-coding-agent/modes/setup-wizard/wizard-overlay";
import * as bundledPiCodingAgentModesShared from "@pk-nerdsaver-ai/pi-coding-agent/modes/shared";
import * as bundledPiCodingAgentModesThemeDefaults from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/defaults";
import * as bundledPiCodingAgentModesThemeMermaidCache from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/mermaid-cache";
import * as bundledPiCodingAgentModesThemeShimmer from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/shimmer";
import * as bundledPiCodingAgentModesThemeTheme from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/theme";
import * as bundledPiCodingAgentModesTurnBudget from "@pk-nerdsaver-ai/pi-coding-agent/modes/turn-budget";
import * as bundledPiCodingAgentModesTypes from "@pk-nerdsaver-ai/pi-coding-agent/modes/types";
import * as bundledPiCodingAgentModesUltrathink from "@pk-nerdsaver-ai/pi-coding-agent/modes/ultrathink";
import * as bundledPiCodingAgentModesUtilsContextUsage from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/context-usage";
import * as bundledPiCodingAgentModesUtilsCopyTargets from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/copy-targets";
import * as bundledPiCodingAgentModesUtilsHotkeysMarkdown from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/hotkeys-markdown";
import * as bundledPiCodingAgentModesUtilsInteractiveContextHelpers from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/interactive-context-helpers";
import * as bundledPiCodingAgentModesUtilsKeybindingMatchers from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/keybinding-matchers";
import * as bundledPiCodingAgentModesUtilsToolsMarkdown from "@pk-nerdsaver-ai/pi-coding-agent/modes/utils/tools-markdown";
...
import * as bundledPiCodingAgentPlanModeState from "@pk-nerdsaver-ai/pi-coding-agent/plan-mode/state";
import * as bundledPiCodingAgentSecrets from "@pk-nerdsaver-ai/pi-coding-agent/secrets";
import * as bundledPiCodingAgentSecretsObfuscator from "@pk-nerdsaver-ai/pi-coding-agent/secrets/obfuscator";
import * as bundledPiCodingAgentSecretsRegex from "@pk-nerdsaver-ai/pi-coding-agent/secrets/regex";
import * as bundledPiCodingAgentSessionAgentSession from "@pk-nerdsaver-ai/pi-coding-agent/session/agent-session";
import * as bundledPiCodingAgentSessionAgentStorage from "@pk-nerdsaver-ai/pi-coding-agent/session/agent-storage";
import * as bundledPiCodingAgentSessionArtifacts from "@pk-nerdsaver-ai/pi-coding-agent/session/artifacts";
import * as bundledPiCodingAgentSessionAuthBrokerConfig from "@pk-nerdsaver-ai/pi-coding-agent/session/auth-broker-config";
import * as bundledPiCodingAgentSessionAuthStorage from "@pk-nerdsaver-ai/pi-coding-agent/session/auth-storage";
...
import * as bundledPiCodingAgentSessionSessionDumpFormat from "@pk-nerdsaver-ai/pi-coding-agent/session/session-dump-format";
import * as bundledPiCodingAgentSessionSessionEntries from "@pk-nerdsaver-ai/pi-coding-agent/session/session-entries";
import * as bundledPiCodingAgentSessionSessionHistoryFormat from "@pk-nerdsaver-ai/pi-coding-agent/session/session-history-format";
import * as bundledPiCodingAgentSessionSessionListing from "@pk-nerdsaver-ai/pi-coding-agent/session/session-listing";
import * as bundledPiCodingAgentSessionSessionLoader from "@pk-nerdsaver-ai/pi-coding-agent/session/session-loader";
import * as bundledPiCodingAgentSessionSessionManager from "@pk-nerdsaver-ai/pi-coding-agent/session/session-manager";
import * as bundledPiCodingAgentSessionSessionMigrations from "@pk-nerdsaver-ai/pi-coding-agent/session/session-migrations";
...
import * as bundledPiCodingAgentSessionSnapcompactInline from "@pk-nerdsaver-ai/pi-coding-agent/session/snapcompact-inline";
import * as bundledPiCodingAgentSessionSnapcompactSavingsJournal from "@pk-nerdsaver-ai/pi-coding-agent/session/snapcompact-savings-journal";
import * as bundledPiCodingAgentSessionSqlSessionStorage from "@pk-nerdsaver-ai/pi-coding-agent/session/sql-session-storage";
import * as bundledPiCodingAgentSessionStreamingOutput from "@pk-nerdsaver-ai/pi-coding-agent/session/streaming-output";
import * as bundledPiCodingAgentSessionToolChoiceQueue from "@pk-nerdsaver-ai/pi-coding-agent/session/tool-choice-queue";
import * as bundledPiCodingAgentSessionTurnPersistence from "@pk-nerdsaver-ai/pi-coding-agent/session/turn-persistence";
import * as bundledPiCodingAgentSessionUnexpectedStopClassifier from "@pk-nerdsaver-ai/pi-coding-agent/session/unexpected-stop-classifier";
import * as bundledPiCodingAgentSessionYieldQueue from "@pk-nerdsaver-ai/pi-coding-agent/session/yield-queue";
import * as bundledPiCodingAgentSlashCommandsAcpBuiltins from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/acp-builtins";
import * as bundledPiCodingAgentSlashCommandsAvailableCommands from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/available-commands";
import * as bundledPiCodingAgentSlashCommandsBuiltinRegistry from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/builtin-registry";
import * as bundledPiCodingAgentSlashCommandsMarketplaceInstallParser from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/marketplace-install-parser";
import * as bundledPiCodingAgentSlashCommandsTypes from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/types";
import * as bundledPiCodingAgentSshConfigWriter from "@pk-nerdsaver-ai/pi-coding-agent/ssh/config-writer";
import * as bundledPiCodingAgentSshConnectionManager from "@pk-nerdsaver-ai/pi-coding-agent/ssh/connection-manager";
import * as bundledPiCodingAgentSshFileTransfer from "@pk-nerdsaver-ai/pi-coding-agent/ssh/file-transfer";
import * as bundledPiCodingAgentSshSshExecutor from "@pk-nerdsaver-ai/pi-coding-agent/ssh/ssh-executor";
import * as bundledPiCodingAgentSshSshfsMount from "@pk-nerdsaver-ai/pi-coding-agent/ssh/sshfs-mount";
import * as bundledPiCodingAgentSshUtils from "@pk-nerdsaver-ai/pi-coding-agent/ssh/utils";
import * as bundledPiCodingAgentStt from "@pk-nerdsaver-ai/pi-coding-agent/stt";
import * as bundledPiCodingAgentSttAsrClient from "@pk-nerdsaver-ai/pi-coding-agent/stt/asr-client";
import * as bundledPiCodingAgentSttAsrProtocol from "@pk-nerdsaver-ai/pi-coding-agent/stt/asr-protocol";
import * as bundledPiCodingAgentSttAsrWorker from "@pk-nerdsaver-ai/pi-coding-agent/stt/asr-worker";
import * as bundledPiCodingAgentSttDownloader from "@pk-nerdsaver-ai/pi-coding-agent/stt/downloader";
import * as bundledPiCodingAgentSttEndpointer from "@pk-nerdsaver-ai/pi-coding-agent/stt/endpointer";
import * as bundledPiCodingAgentSttModels from "@pk-nerdsaver-ai/pi-coding-agent/stt/models";
import * as bundledPiCodingAgentSttRecorder from "@pk-nerdsaver-ai/pi-coding-agent/stt/recorder";
import * as bundledPiCodingAgentSttSttController from "@pk-nerdsaver-ai/pi-coding-agent/stt/stt-controller";
import * as bundledPiCodingAgentSttTranscriber from "@pk-nerdsaver-ai/pi-coding-agent/stt/transcriber";
...
import * as bundledPiCodingAgentToolsAstGrep from "@pk-nerdsaver-ai/pi-coding-agent/tools/ast-grep";
import * as bundledPiCodingAgentToolsAutoGeneratedGuard from "@pk-nerdsaver-ai/pi-coding-agent/tools/auto-generated-guard";
import * as bundledPiCodingAgentToolsBash from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash";
import * as bundledPiCodingAgentToolsBashCommandFixup from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash-command-fixup";
import * as bundledPiCodingAgentToolsBashInteractive from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash-interactive";
import * as bundledPiCodingAgentToolsBashInterceptor from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash-interceptor";
import * as bundledPiCodingAgentToolsBashPtySelection from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash-pty-selection";
import * as bundledPiCodingAgentToolsBashSkillUrls from "@pk-nerdsaver-ai/pi-coding-agent/tools/bash-skill-urls";
import * as bundledPiCodingAgentToolsBrowser from "@pk-nerdsaver-ai/pi-coding-agent/tools/browser";
import * as bundledPiCodingAgentToolsBuiltinNames from "@pk-nerdsaver-ai/pi-coding-agent/tools/builtin-names";
...
import * as bundledPiCodingAgentToolsGhFormat from "@pk-nerdsaver-ai/pi-coding-agent/tools/gh-format";
import * as bundledPiCodingAgentToolsGhRenderer from "@pk-nerdsaver-ai/pi-coding-agent/tools/gh-renderer";
import * as bundledPiCodingAgentToolsGithubCache from "@pk-nerdsaver-ai/pi-coding-agent/tools/github-cache";
import * as bundledPiCodingAgentToolsGlob from "@pk-nerdsaver-ai/pi-coding-agent/tools/glob";
import * as bundledPiCodingAgentToolsGrep from "@pk-nerdsaver-ai/pi-coding-agent/tools/grep";
import * as bundledPiCodingAgentToolsGroupedFileOutput from "@pk-nerdsaver-ai/pi-coding-agent/tools/grouped-file-output";
import * as bundledPiCodingAgentToolsImageGen from "@pk-nerdsaver-ai/pi-coding-agent/tools/image-gen";
...
import * as bundledPiCodingAgentToolsJtdToTypescript from "@pk-nerdsaver-ai/pi-coding-agent/tools/jtd-to-typescript";
import * as bundledPiCodingAgentToolsJtdUtils from "@pk-nerdsaver-ai/pi-coding-agent/tools/jtd-utils";
import * as bundledPiCodingAgentToolsLearn from "@pk-nerdsaver-ai/pi-coding-agent/tools/learn";
import * as bundledPiCodingAgentToolsListLimit from "@pk-nerdsaver-ai/pi-coding-agent/tools/list-limit";
import * as bundledPiCodingAgentToolsManageSkill from "@pk-nerdsaver-ai/pi-coding-agent/tools/manage-skill";
import * as bundledPiCodingAgentToolsMatchLineFormat from "@pk-nerdsaver-ai/pi-coding-agent/tools/match-line-format";
import * as bundledPiCodingAgentToolsMemoryEdit from "@pk-nerdsaver-ai/pi-coding-agent/tools/memory-edit";
import * as bundledPiCodingAgentToolsMemoryRecall from "@pk-nerdsaver-ai/pi-coding-agent/tools/memory-recall";
import * as bundledPiCodingAgentToolsMemoryReflect from "@pk-nerdsaver-ai/pi-coding-agent/tools/memory-reflect";
import * as bundledPiCodingAgentToolsMemoryRender from "@pk-nerdsaver-ai/pi-coding-agent/tools/memory-render";
import * as bundledPiCodingAgentToolsMemoryRetain from "@pk-nerdsaver-ai/pi-coding-agent/tools/memory-retain";
import * as bundledPiCodingAgentToolsOutputMeta from "@pk-nerdsaver-ai/pi-coding-agent/tools/output-meta";
import * as bundledPiCodingAgentToolsOutputSchemaValidator from "@pk-nerdsaver-ai/pi-coding-agent/tools/output-schema-validator";
import * as bundledPiCodingAgentToolsPathUtils from "@pk-nerdsaver-ai/pi-coding-agent/tools/path-utils";
import * as bundledPiCodingAgentToolsPlanModeGuard from "@pk-nerdsaver-ai/pi-coding-agent/tools/plan-mode-guard";
import * as bundledPiCodingAgentToolsRead from "@pk-nerdsaver-ai/pi-coding-agent/tools/read";
import * as bundledPiCodingAgentToolsRenderUtils from "@pk-nerdsaver-ai/pi-coding-agent/tools/render-utils";
import * as bundledPiCodingAgentToolsRenderers from "@pk-nerdsaver-ai/pi-coding-agent/tools/renderers";
...
import * as bundledPiCodingAgentTuiFileList from "@pk-nerdsaver-ai/pi-coding-agent/tui/file-list";
import * as bundledPiCodingAgentTuiHyperlink from "@pk-nerdsaver-ai/pi-coding-agent/tui/hyperlink";
import * as bundledPiCodingAgentTuiOutputBlock from "@pk-nerdsaver-ai/pi-coding-agent/tui/output-block";
import * as bundledPiCodingAgentTuiStatusLine from "@pk-nerdsaver-ai/pi-coding-agent/tui/status-line";
import * as bundledPiCodingAgentTuiTreeList from "@pk-nerdsaver-ai/pi-coding-agent/tui/tree-list";
import * as bundledPiCodingAgentTuiTypes from "@pk-nerdsaver-ai/pi-coding-agent/tui/types";
import * as bundledPiCodingAgentTuiUtils from "@pk-nerdsaver-ai/pi-coding-agent/tui/utils";
import * as bundledPiCodingAgentTuiWidthAwareText from "@pk-nerdsaver-ai/pi-coding-agent/tui/width-aware-text";
import * as bundledPiCodingAgentUtilsActiveRepoContext from "@pk-nerdsaver-ai/pi-coding-agent/utils/active-repo-context";
import * as bundledPiCodingAgentUtilsBlockContext from "@pk-nerdsaver-ai/pi-coding-agent/utils/block-context";
import * as bundledPiCodingAgentUtilsChangelog from "@pk-nerdsaver-ai/pi-coding-agent/utils/changelog";
import * as bundledPiCodingAgentUtilsClipboard from "@pk-nerdsaver-ai/pi-coding-agent/utils/clipboard";
import * as bundledPiCodingAgentUtilsCommandArgs from "@pk-nerdsaver-ai/pi-coding-agent/utils/command-args";
import * as bundledPiCodingAgentUtilsCommitMessageGenerator from "@pk-nerdsaver-ai/pi-coding-agent/utils/commit-message-generator";
import * as bundledPiCodingAgentUtilsEditMode from "@pk-nerdsaver-ai/pi-coding-agent/utils/edit-mode";
import * as bundledPiCodingAgentUtilsEnhancedPaste from "@pk-nerdsaver-ai/pi-coding-agent/utils/enhanced-paste";
import * as bundledPiCodingAgentUtilsEventBus from "@pk-nerdsaver-ai/pi-coding-agent/utils/event-bus";
import * as bundledPiCodingAgentUtilsExternalEditor from "@pk-nerdsaver-ai/pi-coding-agent/utils/external-editor";
import * as bundledPiCodingAgentUtilsFileDisplayMode from "@pk-nerdsaver-ai/pi-coding-agent/utils/file-display-mode";
import * as bundledPiCodingAgentUtilsFileMentions from "@pk-nerdsaver-ai/pi-coding-agent/utils/file-mentions";
import * as bundledPiCodingAgentUtilsGit from "@pk-nerdsaver-ai/pi-coding-agent/utils/git";
import * as bundledPiCodingAgentUtilsImageLoading from "@pk-nerdsaver-ai/pi-coding-agent/utils/image-loading";
import * as bundledPiCodingAgentUtilsImageResize from "@pk-nerdsaver-ai/pi-coding-agent/utils/image-resize";
import * as bundledPiCodingAgentUtilsImageVisionFallback from "@pk-nerdsaver-ai/pi-coding-agent/utils/image-vision-fallback";
import * as bundledPiCodingAgentUtilsIpc from "@pk-nerdsaver-ai/pi-coding-agent/utils/ipc";
import * as bundledPiCodingAgentUtilsJj from "@pk-nerdsaver-ai/pi-coding-agent/utils/jj";
import * as bundledPiCodingAgentUtilsLangFromPath from "@pk-nerdsaver-ai/pi-coding-agent/utils/lang-from-path";
import * as bundledPiCodingAgentUtilsMarkit from "@pk-nerdsaver-ai/pi-coding-agent/utils/markit";
import * as bundledPiCodingAgentUtilsMarkitCache from "@pk-nerdsaver-ai/pi-coding-agent/utils/markit-cache";
import * as bundledPiCodingAgentUtilsMupdfWasmEmbed from "@pk-nerdsaver-ai/pi-coding-agent/utils/mupdf-wasm-embed";
import * as bundledPiCodingAgentUtilsOpen from "@pk-nerdsaver-ai/pi-coding-agent/utils/open";
import * as bundledPiCodingAgentUtilsPromptPath from "@pk-nerdsaver-ai/pi-coding-agent/utils/prompt-path";
import * as bundledPiCodingAgentUtilsQrcode from "@pk-nerdsaver-ai/pi-coding-agent/utils/qrcode";
import * as bundledPiCodingAgentUtilsSessionColor from "@pk-nerdsaver-ai/pi-coding-agent/utils/session-color";
import * as bundledPiCodingAgentUtilsShellSnapshot from "@pk-nerdsaver-ai/pi-coding-agent/utils/shell-snapshot";
import * as bundledPiCodingAgentUtilsSixel from "@pk-nerdsaver-ai/pi-coding-agent/utils/sixel";
import * as bundledPiCodingAgentUtilsThinkingDisplay from "@pk-nerdsaver-ai/pi-coding-agent/utils/thinking-display";
import * as bundledPiCodingAgentUtilsTitleGenerator from "@pk-nerdsaver-ai/pi-coding-agent/utils/title-generator";
import * as bundledPiCodingAgentUtilsToolChoice from "@pk-nerdsaver-ai/pi-coding-agent/utils/tool-choice";
import * as bundledPiCodingAgentUtilsToolsManager from "@pk-nerdsaver-ai/pi-coding-agent/utils/tools-manager";
import * as bundledPiCodingAgentUtilsTurndown from "@pk-nerdsaver-ai/pi-coding-agent/utils/turndown";
import * as bundledPiCodingAgentUtilsZip from "@pk-nerdsaver-ai/pi-coding-agent/utils/zip";
import * as bundledPiCodingAgentWebKagi from "@pk-nerdsaver-ai/pi-coding-agent/web/kagi";
import * as bundledPiCodingAgentWebParallel from "@pk-nerdsaver-ai/pi-coding-agent/web/parallel";
import * as bundledPiCodingAgentWebScrapers from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers";
import * as bundledPiCodingAgentWebScrapersArtifacthub from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/artifacthub";
import * as bundledPiCodingAgentWebScrapersArxiv from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/arxiv";
import * as bundledPiCodingAgentWebScrapersAur from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/aur";
import * as bundledPiCodingAgentWebScrapersBiorxiv from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/biorxiv";
import * as bundledPiCodingAgentWebScrapersBluesky from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/bluesky";
import * as bundledPiCodingAgentWebScrapersBrew from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/brew";
import * as bundledPiCodingAgentWebScrapersCheatsh from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/cheatsh";
import * as bundledPiCodingAgentWebScrapersChocolatey from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/chocolatey";
import * as bundledPiCodingAgentWebScrapersChoosealicense from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/choosealicense";
import * as bundledPiCodingAgentWebScrapersCisaKev from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/cisa-kev";
import * as bundledPiCodingAgentWebScrapersClojars from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/clojars";
import * as bundledPiCodingAgentWebScrapersCoingecko from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/coingecko";
import * as bundledPiCodingAgentWebScrapersCratesIo from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/crates-io";
import * as bundledPiCodingAgentWebScrapersCrossref from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/crossref";
import * as bundledPiCodingAgentWebScrapersDevto from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/devto";
import * as bundledPiCodingAgentWebScrapersDiscogs from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/discogs";
import * as bundledPiCodingAgentWebScrapersDiscourse from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/discourse";
import * as bundledPiCodingAgentWebScrapersDockerhub from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/dockerhub";
import * as bundledPiCodingAgentWebScrapersDocsRs from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/docs-rs";
import * as bundledPiCodingAgentWebScrapersFdroid from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/fdroid";
import * as bundledPiCodingAgentWebScrapersFirefoxAddons from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/firefox-addons";
import * as bundledPiCodingAgentWebScrapersFlathub from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/flathub";
import * as bundledPiCodingAgentWebScrapersGithub from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/github";
import * as bundledPiCodingAgentWebScrapersGithubGist from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/github-gist";
import * as bundledPiCodingAgentWebScrapersGitlab from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/gitlab";
import * as bundledPiCodingAgentWebScrapersGoPkg from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/go-pkg";
import * as bundledPiCodingAgentWebScrapersHackage from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/hackage";
import * as bundledPiCodingAgentWebScrapersHackernews from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/hackernews";
import * as bundledPiCodingAgentWebScrapersHex from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/hex";
import * as bundledPiCodingAgentWebScrapersHuggingface from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/huggingface";
import * as bundledPiCodingAgentWebScrapersIacr from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/iacr";
import * as bundledPiCodingAgentWebScrapersJetbrainsMarketplace from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/jetbrains-marketplace";
import * as bundledPiCodingAgentWebScrapersLemmy from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/lemmy";
import * as bundledPiCodingAgentWebScrapersLobsters from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/lobsters";
import * as bundledPiCodingAgentWebScrapersMastodon from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/mastodon";
import * as bundledPiCodingAgentWebScrapersMaven from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/maven";
import * as bundledPiCodingAgentWebScrapersMdn from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/mdn";
import * as bundledPiCodingAgentWebScrapersMetacpan from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/metacpan";
import * as bundledPiCodingAgentWebScrapersMusicbrainz from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/musicbrainz";
import * as bundledPiCodingAgentWebScrapersNpm from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/npm";
import * as bundledPiCodingAgentWebScrapersNuget from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/nuget";
import * as bundledPiCodingAgentWebScrapersNvd from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/nvd";
import * as bundledPiCodingAgentWebScrapersOllama from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/ollama";
import * as bundledPiCodingAgentWebScrapersOpenVsx from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/open-vsx";
import * as bundledPiCodingAgentWebScrapersOpencorporates from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/opencorporates";
import * as bundledPiCodingAgentWebScrapersOpenlibrary from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/openlibrary";
import * as bundledPiCodingAgentWebScrapersOrcid from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/orcid";
import * as bundledPiCodingAgentWebScrapersOsv from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/osv";
import * as bundledPiCodingAgentWebScrapersPackagist from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/packagist";
import * as bundledPiCodingAgentWebScrapersPubDev from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pub-dev";
import * as bundledPiCodingAgentWebScrapersPubmed from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pubmed";
import * as bundledPiCodingAgentWebScrapersPypi from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pypi";
import * as bundledPiCodingAgentWebScrapersRawg from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rawg";
import * as bundledPiCodingAgentWebScrapersReadthedocs from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/readthedocs";
import * as bundledPiCodingAgentWebScrapersReddit from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/reddit";
import * as bundledPiCodingAgentWebScrapersRepology from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/repology";
import * as bundledPiCodingAgentWebScrapersRfc from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rfc";
import * as bundledPiCodingAgentWebScrapersRubygems from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rubygems";
import * as bundledPiCodingAgentWebScrapersSearchcode from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/searchcode";
import * as bundledPiCodingAgentWebScrapersSecEdgar from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/sec-edgar";
import * as bundledPiCodingAgentWebScrapersSemanticScholar from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/semantic-scholar";
import * as bundledPiCodingAgentWebScrapersSnapcraft from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/snapcraft";
import * as bundledPiCodingAgentWebScrapersSourcegraph from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/sourcegraph";
import * as bundledPiCodingAgentWebScrapersSpdx from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/spdx";
import * as bundledPiCodingAgentWebScrapersSpotify from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/spotify";
import * as bundledPiCodingAgentWebScrapersStackoverflow from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/stackoverflow";
import * as bundledPiCodingAgentWebScrapersTerraform from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/terraform";
import * as bundledPiCodingAgentWebScrapersTldr from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/tldr";
import * as bundledPiCodingAgentWebScrapersTwitter from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/twitter";
import * as bundledPiCodingAgentWebScrapersTypes from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/types";
import * as bundledPiCodingAgentWebScrapersUtils from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/utils";
import * as bundledPiCodingAgentWebScrapersVimeo from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/vimeo";
import * as bundledPiCodingAgentWebScrapersVscodeMarketplace from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/vscode-marketplace";
import * as bundledPiCodingAgentWebScrapersW3c from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/w3c";
import * as bundledPiCodingAgentWebScrapersWikidata from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/wikidata";
import * as bundledPiCodingAgentWebScrapersWikipedia from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/wikipedia";
import * as bundledPiCodingAgentWebScrapersYoutube from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/youtube";
import * as bundledPiCodingAgentWebSearch from "@pk-nerdsaver-ai/pi-coding-agent/web/search";
import * as bundledPiCodingAgentWebSearchProvider from "@pk-nerdsaver-ai/pi-coding-agent/web/search/provider";
import * as bundledPiCodingAgentWebSearchProvidersAnthropic from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/anthropic";
import * as bundledPiCodingAgentWebSearchProvidersBase from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/base";
import * as bundledPiCodingAgentWebSearchProvidersBrave from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/brave";
import * as bundledPiCodingAgentWebSearchProvidersCodex from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/codex";
import * as bundledPiCodingAgentWebSearchProvidersDuckduckgo from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/duckduckgo";
import * as bundledPiCodingAgentWebSearchProvidersExa from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/exa";
import * as bundledPiCodingAgentWebSearchProvidersFirecrawl from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/firecrawl";
import * as bundledPiCodingAgentWebSearchProvidersGemini from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/gemini";
import * as bundledPiCodingAgentWebSearchProvidersJina from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/jina";
import * as bundledPiCodingAgentWebSearchProvidersKagi from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/kagi";
import * as bundledPiCodingAgentWebSearchProvidersKimi from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/kimi";
import * as bundledPiCodingAgentWebSearchProvidersParallel from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/parallel";
import * as bundledPiCodingAgentWebSearchProvidersPerplexity from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/perplexity";
import * as bundledPiCodingAgentWebSearchProvidersPerplexityAuth from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/perplexity-auth";
import * as bundledPiCodingAgentWebSearchProvidersSearxng from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/searxng";
import * as bundledPiCodingAgentWebSearchProvidersSynthetic from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/synthetic";
import * as bundledPiCodingAgentWebSearchProvidersTavily from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/tavily";
import * as bundledPiCodingAgentWebSearchProvidersTinyfish from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/tinyfish";
import * as bundledPiCodingAgentWebSearchProvidersUtils from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/utils";
import * as bundledPiCodingAgentWebSearchProvidersXai from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/xai";
import * as bundledPiCodingAgentWebSearchProvidersZai from "@pk-nerdsaver-ai/pi-coding-agent/web/search/providers/zai";
...
import * as bundledPiTuiComponentsEditor from "@pk-nerdsaver-ai/pi-tui/components/editor";
import * as bundledPiTuiComponentsImage from "@pk-nerdsaver-ai/pi-tui/components/image";
import * as bundledPiTuiComponentsInput from "@pk-nerdsaver-ai/pi-tui/components/input";
import * as bundledPiTuiComponentsLoader from "@pk-nerdsaver-ai/pi-tui/components/loader";
import * as bundledPiTuiComponentsMarkdown from "@pk-nerdsaver-ai/pi-tui/components/markdown";
import * as bundledPiTuiComponentsScrollView from "@pk-nerdsaver-ai/pi-tui/components/scroll-view";
import * as bundledPiTuiComponentsSelectList from "@pk-nerdsaver-ai/pi-tui/components/select-list";
import * as bundledPiTuiComponentsSettingsList from "@pk-nerdsaver-ai/pi-tui/components/settings-list";
import * as bundledPiTuiComponentsSpacer from "@pk-nerdsaver-ai/pi-tui/components/spacer";
import * as bundledPiTuiComponentsTabBar from "@pk-nerdsaver-ai/pi-tui/components/tab-bar";
import * as bundledPiTuiComponentsText from "@pk-nerdsaver-ai/pi-tui/components/text";
import * as bundledPiTuiComponentsTruncatedText from "@pk-nerdsaver-ai/pi-tui/components/truncated-text";
import * as bundledPiUtils from "@pk-nerdsaver-ai/pi-utils";
...
export const BUNDLED_PI_REGISTRY: Readonly<Record<string, Readonly<Record<string, unknown>>>> = {
	...
	"@pk-nerdsaver-ai/pi-agent-core/compaction/entries": bundledPiAgentCoreCompactionEntries as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-agent-core/compaction/errors": bundledPiAgentCoreCompactionErrors as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-agent-core/compaction/messages": bundledPiAgentCoreCompactionMessages as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-agent-core/compaction/openai": bundledPiAgentCoreCompactionOpenai as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-agent-core/compaction/pruning": bundledPiAgentCoreCompactionPruning as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-agent-core/compaction/shake": bundledPiAgentCoreCompactionShake as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-agent-core/compaction/utils": bundledPiAgentCoreCompactionUtils as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai": bundledPiAi as unknown as Readonly<Record<string, unknown>>,
	...
	"@pk-nerdsaver-ai/pi-ai/auth-broker/discover": bundledPiAiAuthBrokerDiscover as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/auth-broker/refresher": bundledPiAiAuthBrokerRefresher as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/providers/amazon-bedrock": bundledPiAiProvidersAmazonBedrock as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/anthropic-client": bundledPiAiProvidersAnthropicClient as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/providers/gitlab-duo-workflow": bundledPiAiProvidersGitlabDuoWorkflow as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/gitlab-duo": bundledPiAiProvidersGitlabDuo as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/google-auth": bundledPiAiProvidersGoogleAuth as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/providers/google-shared": bundledPiAiProvidersGoogleShared as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/google-types": bundledPiAiProvidersGoogleTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/providers/openai-responses": bundledPiAiProvidersOpenaiResponses as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/openai-shared": bundledPiAiProvidersOpenaiShared as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/pi-native-client": bundledPiAiProvidersPiNativeClient as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/pi-native-server": bundledPiAiProvidersPiNativeServer as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/providers/transform-messages": bundledPiAiProvidersTransformMessages as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/providers/vision-guard": bundledPiAiProvidersVisionGuard as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/usage/github-copilot": bundledPiAiUsageGithubCopilot as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/usage/google-antigravity": bundledPiAiUsageGoogleAntigravity as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-ai/utils/sdk-stream-timeout": bundledPiAiUtilsSdkStreamTimeout as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/utils/sse-debug": bundledPiAiUtilsSseDebug as unknown as Readonly<Record<string, unknown>>,
	...
	"@pk-nerdsaver-ai/pi-ai/oauth/callback-server": bundledPiAiOauthCallbackServer as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/oauth/cursor": bundledPiAiOauthCursor as unknown as Readonly<Record<string, unknown>>,
	"@pk-nerdsaver-ai/pi-ai/oauth/devin": bundledPiAiOauthDevin as unknown as Readonly<Record<string, unknown>>,
	"@pk-nerdsaver-ai/pi-ai/oauth/github-copilot": bundledPiAiOauthGithubCopilot as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/oauth/gitlab-duo-workflow": bundledPiAiOauthGitlabDuoWorkflow as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/oauth/gitlab-duo": bundledPiAiOauthGitlabDuo as unknown as Readonly<Record<string, unknown>>,
	"@pk-nerdsaver-ai/pi-ai/oauth/google-antigravity": bundledPiAiOauthGoogleAntigravity as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/oauth/google-gemini-cli": bundledPiAiOauthGoogleGeminiCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-ai/oauth/google-oauth-shared": bundledPiAiOauthGoogleOauthShared as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commit/analysis": bundledPiCodingAgentCommitAnalysis as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commit/changelog": bundledPiCodingAgentCommitChangelog as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commit/map-reduce": bundledPiCodingAgentCommitMapReduce as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers": bundledPiCodingAgentWebScrapers as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/search": bundledPiCodingAgentWebSearch as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/capability/ssh": bundledPiCodingAgentCapabilitySsh as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/capability/tool": bundledPiCodingAgentCapabilityTool as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/cli/completion-gen": bundledPiCodingAgentCliCompletionGen as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/config-cli": bundledPiCodingAgentCliConfigCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/dry-balance-cli": bundledPiCodingAgentCliDryBalanceCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/extension-flags": bundledPiCodingAgentCliExtensionFlags as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/file-processor": bundledPiCodingAgentCliFileProcessor as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/flag-tables": bundledPiCodingAgentCliFlagTables as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/cli/grep-cli": bundledPiCodingAgentCliGrepCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/grievances-cli": bundledPiCodingAgentCliGrievancesCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/initial-message": bundledPiCodingAgentCliInitialMessage as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/cli/read-cli": bundledPiCodingAgentCliReadCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/session-picker": bundledPiCodingAgentCliSessionPicker as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/cli/shell-cli": bundledPiCodingAgentCliShellCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/ssh-cli": bundledPiCodingAgentCliSshCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/startup-cwd": bundledPiCodingAgentCliStartupCwd as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/stats-cli": bundledPiCodingAgentCliStatsCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/tiny-models-cli": bundledPiCodingAgentCliTinyModelsCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/ttsr-cli": bundledPiCodingAgentCliTtsrCli as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/cli/usage-cli": bundledPiCodingAgentCliUsageCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/web-search-cli": bundledPiCodingAgentCliWebSearchCli as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/cli/worktree-cli": bundledPiCodingAgentCliWorktreeCli as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commands/gallery": bundledPiCodingAgentCommandsGallery as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/gc": bundledPiCodingAgentCommandsGc as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commands/install": bundledPiCodingAgentCommandsInstall as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/join": bundledPiCodingAgentCommandsJoin as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/launch": bundledPiCodingAgentCommandsLaunch as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commands/say": bundledPiCodingAgentCommandsSay as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/setup": bundledPiCodingAgentCommandsSetup as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/shell": bundledPiCodingAgentCommandsShell as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/ssh": bundledPiCodingAgentCommandsSsh as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commands/token": bundledPiCodingAgentCommandsToken as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/ttsr": bundledPiCodingAgentCommandsTtsr as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/update": bundledPiCodingAgentCommandsUpdate as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/usage": bundledPiCodingAgentCommandsUsage as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/web-search": bundledPiCodingAgentCommandsWebSearch as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commands/worktree": bundledPiCodingAgentCommandsWorktree as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commit/cli": bundledPiCodingAgentCommitCli as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/commit/pipeline": bundledPiCodingAgentCommitPipeline as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commit/shared-llm": bundledPiCodingAgentCommitSharedLlm as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/commit/types": bundledPiCodingAgentCommitTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/dap/client": bundledPiCodingAgentDapClient as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/dap/config": bundledPiCodingAgentDapConfig as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/debug/report-bundle": bundledPiCodingAgentDebugReportBundle as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/debug/system-info": bundledPiCodingAgentDebugSystemInfo as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/debug/terminal-info": bundledPiCodingAgentDebugTerminalInfo as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/agents-md": bundledPiCodingAgentDiscoveryAgentsMd as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/claude": bundledPiCodingAgentDiscoveryClaude as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/cline": bundledPiCodingAgentDiscoveryCline as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/codex": bundledPiCodingAgentDiscoveryCodex as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/cursor": bundledPiCodingAgentDiscoveryCursor as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/gemini": bundledPiCodingAgentDiscoveryGemini as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/github": bundledPiCodingAgentDiscoveryGithub as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/helpers": bundledPiCodingAgentDiscoveryHelpers as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/ssh": bundledPiCodingAgentDiscoverySsh as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/discovery/vscode": bundledPiCodingAgentDiscoveryVscode as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/edit/normalize": bundledPiCodingAgentEditNormalize as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/edit/notebook": bundledPiCodingAgentEditNotebook as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/edit/read-file": bundledPiCodingAgentEditReadFile as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/edit/renderer": bundledPiCodingAgentEditRenderer as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/edit/modes/patch": bundledPiCodingAgentEditModesPatch as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/edit/modes/replace": bundledPiCodingAgentEditModesReplace as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/export/custom-share": bundledPiCodingAgentExportCustomShare as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/export/share": bundledPiCodingAgentExportShare as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/internal-urls/parse": bundledPiCodingAgentInternalUrlsParse as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/internal-urls/types": bundledPiCodingAgentInternalUrlsTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/eval/js/executor": bundledPiCodingAgentEvalJsExecutor as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/eval/js/tool-bridge": bundledPiCodingAgentEvalJsToolBridge as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/eval/py/display": bundledPiCodingAgentEvalPyDisplay as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/eval/py/executor": bundledPiCodingAgentEvalPyExecutor as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/eval/py/kernel": bundledPiCodingAgentEvalPyKernel as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/eval/py/prelude": bundledPiCodingAgentEvalPyPrelude as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/lsp/format-options": bundledPiCodingAgentLspFormatOptions as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/lsp/lspmux": bundledPiCodingAgentLspLspmux as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/lsp/render": bundledPiCodingAgentLspRender as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/markit/registry": bundledPiCodingAgentMarkitRegistry as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/markit/types": bundledPiCodingAgentMarkitTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/client": bundledPiCodingAgentMcpClient as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/config-writer": bundledPiCodingAgentMcpConfigWriter as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/json-rpc": bundledPiCodingAgentMcpJsonRpc as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/loader": bundledPiCodingAgentMcpLoader as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/startup-events": bundledPiCodingAgentMcpStartupEvents as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/timeout": bundledPiCodingAgentMcpTimeout as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/mcp/tool-bridge": bundledPiCodingAgentMcpToolBridge as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/hindsight/backend": bundledPiCodingAgentHindsightBackend as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/hindsight/bank": bundledPiCodingAgentHindsightBank as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/hindsight/client": bundledPiCodingAgentHindsightClient as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/hindsight/config": bundledPiCodingAgentHindsightConfig as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/hindsight/content": bundledPiCodingAgentHindsightContent as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/modes/runtime-init": bundledPiCodingAgentModesRuntimeInit as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/modes/setup-version": bundledPiCodingAgentModesSetupVersion as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/shared": bundledPiCodingAgentModesShared as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/turn-budget": bundledPiCodingAgentModesTurnBudget as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/types": bundledPiCodingAgentModesTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/ultrathink": bundledPiCodingAgentModesUltrathink as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/workflow": bundledPiCodingAgentModesWorkflow as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/acp/acp-agent": bundledPiCodingAgentModesAcpAcpAgent as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/modes/components/snapcompact-shape-preview":
	...
	"@pk-nerdsaver-ai/pi-coding-agent/modes/theme/shimmer": bundledPiCodingAgentModesThemeShimmer as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/modes/theme/theme": bundledPiCodingAgentModesThemeTheme as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/plan-mode/state": bundledPiCodingAgentPlanModeState as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/secrets/obfuscator": bundledPiCodingAgentSecretsObfuscator as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/session/shake-types": bundledPiCodingAgentSessionShakeTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/session/snapcompact-inline":
		bundledPiCodingAgentSessionSnapcompactInline as unknown as Readonly<Record<string, unknown>>,
	"@pk-nerdsaver-ai/pi-coding-agent/session/snapcompact-savings-journal":
	...
	"@pk-nerdsaver-ai/pi-coding-agent/session/yield-queue": bundledPiCodingAgentSessionYieldQueue as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/ssh/file-transfer": bundledPiCodingAgentSshFileTransfer as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/ssh/ssh-executor": bundledPiCodingAgentSshSshExecutor as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/stt/asr-client": bundledPiCodingAgentSttAsrClient as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/asr-protocol": bundledPiCodingAgentSttAsrProtocol as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/asr-worker": bundledPiCodingAgentSttAsrWorker as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/downloader": bundledPiCodingAgentSttDownloader as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/endpointer": bundledPiCodingAgentSttEndpointer as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/models": bundledPiCodingAgentSttModels as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/recorder": bundledPiCodingAgentSttRecorder as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/stt/stt-controller": bundledPiCodingAgentSttSttController as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/task/name-generator": bundledPiCodingAgentTaskNameGenerator as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/task/omp-command": bundledPiCodingAgentTaskOmpCommand as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/task/output-manager": bundledPiCodingAgentTaskOutputManager as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/task/types": bundledPiCodingAgentTaskTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/ast-edit": bundledPiCodingAgentToolsAstEdit as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/ast-grep": bundledPiCodingAgentToolsAstGrep as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/bash": bundledPiCodingAgentToolsBash as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/browser": bundledPiCodingAgentToolsBrowser as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/builtin-names": bundledPiCodingAgentToolsBuiltinNames as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/context": bundledPiCodingAgentToolsContext as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/debug": bundledPiCodingAgentToolsDebug as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/eval-backends": bundledPiCodingAgentToolsEvalBackends as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/eval-render": bundledPiCodingAgentToolsEvalRender as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/eval": bundledPiCodingAgentToolsEval as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/fetch": bundledPiCodingAgentToolsFetch as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/gh-format": bundledPiCodingAgentToolsGhFormat as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/github-cache": bundledPiCodingAgentToolsGithubCache as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/glob": bundledPiCodingAgentToolsGlob as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/grep": bundledPiCodingAgentToolsGrep as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/image-gen": bundledPiCodingAgentToolsImageGen as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/jtd-utils": bundledPiCodingAgentToolsJtdUtils as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/learn": bundledPiCodingAgentToolsLearn as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/list-limit": bundledPiCodingAgentToolsListLimit as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/memory-render": bundledPiCodingAgentToolsMemoryRender as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/memory-retain": bundledPiCodingAgentToolsMemoryRetain as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/output-meta": bundledPiCodingAgentToolsOutputMeta as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/read": bundledPiCodingAgentToolsRead as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tools/render-utils": bundledPiCodingAgentToolsRenderUtils as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/tools/yield": bundledPiCodingAgentToolsYield as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tui/code-cell": bundledPiCodingAgentTuiCodeCell as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tui/file-list": bundledPiCodingAgentTuiFileList as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tui/hyperlink": bundledPiCodingAgentTuiHyperlink as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tui/output-block": bundledPiCodingAgentTuiOutputBlock as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/tui/status-line": bundledPiCodingAgentTuiStatusLine as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/utils/block-context": bundledPiCodingAgentUtilsBlockContext as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/changelog": bundledPiCodingAgentUtilsChangelog as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/clipboard": bundledPiCodingAgentUtilsClipboard as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/command-args": bundledPiCodingAgentUtilsCommandArgs as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/utils/image-loading": bundledPiCodingAgentUtilsImageLoading as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/image-resize": bundledPiCodingAgentUtilsImageResize as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/utils/open": bundledPiCodingAgentUtilsOpen as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/prompt-path": bundledPiCodingAgentUtilsPromptPath as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/qrcode": bundledPiCodingAgentUtilsQrcode as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/utils/tool-choice": bundledPiCodingAgentUtilsToolChoice as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/utils/tools-manager": bundledPiCodingAgentUtilsToolsManager as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/arxiv": bundledPiCodingAgentWebScrapersArxiv as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/github": bundledPiCodingAgentWebScrapersGithub as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/gitlab": bundledPiCodingAgentWebScrapersGitlab as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/iacr": bundledPiCodingAgentWebScrapersIacr as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/npm": bundledPiCodingAgentWebScrapersNpm as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/nuget": bundledPiCodingAgentWebScrapersNuget as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/nvd": bundledPiCodingAgentWebScrapersNvd as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/orcid": bundledPiCodingAgentWebScrapersOrcid as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pubmed": bundledPiCodingAgentWebScrapersPubmed as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pypi": bundledPiCodingAgentWebScrapersPypi as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rawg": bundledPiCodingAgentWebScrapersRawg as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/types": bundledPiCodingAgentWebScrapersTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/utils": bundledPiCodingAgentWebScrapersUtils as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/vimeo": bundledPiCodingAgentWebScrapersVimeo as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-coding-agent/web/search/provider": bundledPiCodingAgentWebSearchProvider as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/search/render": bundledPiCodingAgentWebSearchRender as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/search/types": bundledPiCodingAgentWebSearchTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-coding-agent/web/search/utils": bundledPiCodingAgentWebSearchUtils as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-tui/components/markdown": bundledPiTuiComponentsMarkdown as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-tui/components/scroll-view": bundledPiTuiComponentsScrollView as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-tui/components/select-list": bundledPiTuiComponentsSelectList as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@pk-nerdsaver-ai/pi-tui/components/truncated-text": bundledPiTuiComponentsTruncatedText as unknown as Readonly<
		Record<string, unknown>
	>,
	"@pk-nerdsaver-ai/pi-utils": bundledPiUtils as unknown as Readonly<Record<string, unknown>>,
