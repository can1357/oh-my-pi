...
<title>PyO3 methods</title>

<user># Migrate auth storage to keyed credentials

Replace the flat token store with per-provider keyed credentials; migrate existing entries on first load.</user>
