...
- Fixed LSP startup using a resumed session's recorded project after execution fell back to a different active working directory ([#12526](https://github.com/can1357/oh-my-pi/pull/12526) by [@btimothy-har](https://github.com/btimothy-har)).
