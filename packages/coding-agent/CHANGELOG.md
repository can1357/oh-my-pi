...
- Fixed automatic daemon restarts dropping the completion notification for the exited child generation; the completion is now delivered before the replacement generation is launched.
