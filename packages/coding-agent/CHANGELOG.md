...
- Model discovery rejected with 401/403 now surfaces an authentication error in the /models hub instead of a silently empty model list. ([#12281](https://github.com/can1357/oh-my-pi/issues/12281))
