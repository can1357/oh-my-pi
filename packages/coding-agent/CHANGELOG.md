...
- Anthropic sessions with server-side compaction and experimental context notes no longer fail every request with `compaction block must be sent first`; the notebook now follows the compaction summary instead of preceding it ([#13387](https://github.com/can1357/oh-my-pi/pull/13387) by [@ParadaCarleton](https://github.com/ParadaCarleton)).
