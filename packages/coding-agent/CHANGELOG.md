...
- Fixed the `mcp.json` schema falsely rejecting documented per-server options (`timeout`, `enabled`, `auth`, `oauth`, `requestIdFormat`) as unexpected properties in editors ([#13007](https://github.com/can1357/oh-my-pi/pull/13007) by [@yistc](https://github.com/yistc)).
