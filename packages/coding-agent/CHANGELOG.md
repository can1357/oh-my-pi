...
- Added built-in Nous Portal setup through the Hermes subscription proxy, including `/login nous`, live model discovery, and credential-boundary documentation.
