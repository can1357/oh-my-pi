...
- Built-in whole-file `local://` writes now commit through the native handle-relative atomic writer instead of ACP, LSP, or pathname-based fallbacks, preserving complete old-or-new visibility and truthful cancellation outcomes.
