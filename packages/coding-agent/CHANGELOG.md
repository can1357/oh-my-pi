...
- Added TinyFish as an optional reader backend for the fetch/read URL tool, configurable with `TINYFISH_API_KEY` and `TINYFISH_FETCH_BASE_URL` ([#13221](https://github.com/can1357/oh-my-pi/pull/13221) by [@riique](https://github.com/riique)).
