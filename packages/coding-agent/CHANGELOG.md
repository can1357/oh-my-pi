...
- Agents can bundle watchdog definitions and reference shared watchdogs by ID. `WATCHDOG.yml` can assign watchdogs to named agents and reuse bundled definitions.
