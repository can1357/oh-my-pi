...
- Documented that a restart reconstruction must omit `model` (or re-pass the session's *active* model), since any supplied model is treated as explicit and suppresses restoring the user's current selection from the transcript ([#10289](https://github.com/can1357/oh-my-pi/pull/10289) by [@mattwilkinsonn](https://github.com/mattwilkinsonn)).
