...
- Added global and per-provider `modelDiscovery.mode` (`auto`, `merge`, `replace`) and `cacheTtlMs` policies in `models.yml` ([#12059](https://github.com/can1357/oh-my-pi/pull/12059) by [@yyyllllming](https://github.com/yyyllllming)).
...
- Isolated discovered model caches and publication by endpoint and effective credential identity; removed IDs stay removed during failed/offline refreshes, while explicit models remain available ([#12059](https://github.com/can1357/oh-my-pi/pull/12059) by [@yyyllllming](https://github.com/yyyllllming)).
