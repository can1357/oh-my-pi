...
- Added an opt-in prompt-suggestions extension example with `@tiny` ghost text, focused Tab acceptance, and a documented secret-obfuscation limitation requiring maintainer review.
