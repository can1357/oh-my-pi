...
- Fixed a stale "No models available" warning after signing in during the setup wizard: the registry now re-runs discovery once the wizard completes, and the warning is dropped when a usable model is available ([#12281](https://github.com/can1357/oh-my-pi/issues/12281)).
