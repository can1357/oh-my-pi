...
- Added an opt-in prompt-suggestions extension example with `@tiny` ghost text, focused Tab acceptance, and a documented secret-obfuscation limitation requiring maintainer review ([#12165](https://github.com/can1357/oh-my-pi/pull/12165) by [@haixing23](https://github.com/haixing23)).
