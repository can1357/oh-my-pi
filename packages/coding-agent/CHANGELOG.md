...
- Fixed `/review` using the startup checkout after `/wt` relocates a session, so branch and diff operations now follow the active worktree ([#12565](https://github.com/can1357/oh-my-pi/pull/12565) by [@domenicomassafra](https://github.com/domenicomassafra)).
