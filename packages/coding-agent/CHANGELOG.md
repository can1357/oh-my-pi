...
- Added a user-facing guide to internal URL schemes, including how to list and read `local://` plans and session artifacts ([#10389](https://github.com/can1357/oh-my-pi/issues/10389)).
