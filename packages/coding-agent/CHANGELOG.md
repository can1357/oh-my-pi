...
- Added `cost.longContext` to `models.yml` model definitions and `modelOverrides` so gateway/proxy models can declare a premium long-context pricing tier; with extended context off the working window caps at the tier threshold, matching bundled long-context models ([#13175](https://github.com/can1357/oh-my-pi/pull/13175) by [@maatheusgois-dd](https://github.com/maatheusgois-dd)).
