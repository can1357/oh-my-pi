...
- Unreadable directories no longer silently look empty: advisor transcript costs, memory consolidation, Claude/Codex session imports, and agent discovery now log a warning naming the directory they could not read. Memory cleanup additionally refuses to delete a directory it failed to read instead of treating the failure as empty ([#11554](https://github.com/can1357/oh-my-pi/pull/11554) by [@nikkoxgonzales](https://github.com/nikkoxgonzales)).
