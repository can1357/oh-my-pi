...
- File mentions now accept line selectors such as `@src/app.ts:40-80` and `@src/app.ts:1-5,20-30`, injecting only the requested lines into the prompt ([#10623](https://github.com/can1357/oh-my-pi/pull/10623) by [@kml93](https://github.com/kml93)).
