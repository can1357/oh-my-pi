...
- Fixed Google Antigravity image generation and web search requests sending `requestType: "agent"`, omitting the field to match official Antigravity client behavior.
