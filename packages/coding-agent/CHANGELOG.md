...
- Recycled the retained Python eval kernel after a cell when its RSS exceeds `python.maxRssMb` (default 1024; 0 disables), so a long-lived session cannot pin tens of GB ([#12631](https://github.com/can1357/oh-my-pi/issues/12631), [#12637](https://github.com/can1357/oh-my-pi/pull/12637) by [@RaviTharuma](https://github.com/RaviTharuma)).
