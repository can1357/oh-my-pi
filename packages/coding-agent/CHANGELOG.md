...
- Added `auth.hotWindowFraction` setting to configure the short-window demotion threshold ([#13054](https://github.com/can1357/oh-my-pi/pull/13054) by [@zhaob1n](https://github.com/zhaob1n)).
