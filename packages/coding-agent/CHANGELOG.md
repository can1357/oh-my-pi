...
- Fixed \`omp completions bash\` emitting carriage returns on CRLF checkouts, causing \`bash: '\r': commande introuvable\` ([#11965](https://github.com/can1357/oh-my-pi/pull/11965) by [@yomgui1](https://github.com/yomgui1)).
