...
- Added main-session launches via `--agent <name>` that load the selected agent definition, including ordered model fallback, effort, tools, and structured output.
