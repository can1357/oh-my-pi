...
import type { BrowseResponse, CancelResponse, LogsResponse, StatusResponse, TriggerResponse } from "./types";
...
export const api = {
	...
	trigger(body: { mode: "triage" | "retry"; issue?: string; delivery_id?: string }): Promise<TriggerResponse> {
