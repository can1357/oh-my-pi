		...
		<div class="rmp-vitals">
			...
			<div class="rmp-vital-big">
				<div class="rmp-vital-big-cell">
					...
					<span class={`rmp-vital-big-num${runningTotal() > 0 ? " running-nonzero" : ""}`}>{runningTotal()}</span>
				</div>
				<div class="rmp-vital-big-cell">
					<span class="rmp-vital-big-label">failed</span>
					<span class={`rmp-vital-big-num${failedCount() > 0 ? " failed-nonzero" : ""}`}>{failedCount()}</span>
				</div>
			</div>
			...
			<div class="rmp-vital-runtime">
				...
				<RuntimeRow
					label="conc"
					value={runtime()?.max_concurrency != null ? String(runtime()?.max_concurrency) : undefined}
				/>
				<RuntimeRow
					label="up"
					value={runtime()?.uptime_seconds != null ? fmtDuration(runtime()?.uptime_seconds) : undefined}
				/>
